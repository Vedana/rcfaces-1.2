...
public class Properties {
	...
	public static final String PROCESS_RULES = "processRules";
	...
	static {
		if (Constants.COMPACTED_PROPERTY_NAME) {
			PropertiesRepository.declareProperties(new String[] {BASE,BASE_NAME,BUNDLE_NAME,CLIENT_MESSAGE_ID_FILTER,CLIENT_VALIDATION,DISABLED_COOKIES_PAGE_URL,DISABLED_IEIMAGE_BAR,DISABLED_SCRIPT_PAGE_URL,DISABLE_CACHE,DISABLE_CONTEXT_MENU,DOMAIN,FAVORITE_IMAGE_URL,INVALID_BROWSER_PAGE_URL,LITERAL_LOCALE,LITERAL_TIME_ZONE,MERGE_SCRIPTS,MERGE_STYLES,OVERRIDE,PREFIX,PROCESS_RULES,RENDER_BASE_TAG,REQUIRED_CLASSES,REQUIRED_FILES,REQUIRED_MODULES,REQUIRED_SETS,SERVER_SCOPE,SIDE,SRC,SRC_CHAR_SET,TEXT,TITLE,URI,USER_AGENT,USER_AGENT_VARY,WAI_ROLES_NS});
		}
	}
}
