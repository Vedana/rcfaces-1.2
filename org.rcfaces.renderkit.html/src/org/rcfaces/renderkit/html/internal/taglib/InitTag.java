...
public class InitTag extends CameliaTag implements Tag {
    ...
    protected void setProperties(UIComponent uiComponent) {
        if (LOG.isDebugEnabled()) {
            ...
            LOG
                    .debug("  disabledScriptPageURL='" + disabledScriptPageURL
                            + "'");
            LOG.debug("  disabledCookiesPageURL='" + disabledCookiesPageURL
                    + "'");
            LOG
                    .debug("  invalidBrowserPageURL='" + invalidBrowserPageURL
                            + "'");
            ...
            LOG
                    .debug("  clientMessageIdFilter='" + clientMessageIdFilter
                            + "'");
        ...
        if ((uiComponent instanceof InitComponent) == false) {
            ...
            throw new IllegalStateException(
                    "Component specified by tag is not instanceof of 'InitComponent'.");
        }
        ...
        if (favoriteImageURL != null) {
            if (isValueReference(favoriteImageURL)) {
                ValueBinding vb = application
                        .createValueBinding(favoriteImageURL);
        ...
        if (disabledScriptPageURL != null) {
            if (isValueReference(disabledScriptPageURL)) {
                ValueBinding vb = application
                        .createValueBinding(disabledScriptPageURL);
                component.setValueBinding(Properties.DISABLED_SCRIPT_PAGE_URL,
                        vb);
        ...
        if (disabledCookiesPageURL != null) {
            if (isValueReference(disabledCookiesPageURL)) {
                ValueBinding vb = application
                        .createValueBinding(disabledCookiesPageURL);
                component.setValueBinding(Properties.DISABLED_COOKIES_PAGE_URL,
                        vb);
        ...
        if (invalidBrowserPageURL != null) {
            if (isValueReference(invalidBrowserPageURL)) {
                ValueBinding vb = application
                        .createValueBinding(invalidBrowserPageURL);
                component.setValueBinding(Properties.INVALID_BROWSER_PAGE_URL,
                        vb);
        ...
        if (disabledIEImageBar != null) {
            if (isValueReference(disabledIEImageBar)) {
                ValueBinding vb = application
                        .createValueBinding(disabledIEImageBar);
        ...
        if (disableContextMenu != null) {
            if (isValueReference(disableContextMenu)) {
                ValueBinding vb = application
                        .createValueBinding(disableContextMenu);
        ...
        if (clientMessageIdFilter != null) {
            if (isValueReference(clientMessageIdFilter)) {
                ValueBinding vb = application
                        .createValueBinding(clientMessageIdFilter);
                component.setValueBinding(Properties.CLIENT_MESSAGE_ID_FILTER,
                        vb);
        ...
        if (clientValidation != null) {
            if (isValueReference(clientValidation)) {
                ValueBinding vb = application
                        .createValueBinding(clientValidation);
