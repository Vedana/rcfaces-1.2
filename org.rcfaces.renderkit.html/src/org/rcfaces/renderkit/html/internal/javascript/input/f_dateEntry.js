...
var __members={
	...
	f_dateEntry: function() {
		...
		this._showOnFocus=f_core.GetAttribute(this, f_core._VNS+":showOnFocus");
		
		var twoDigitYearStart=f_core.GetAttribute(this, f_core._VNS+":twoDigitYearStart");
	...
	*/
	...
	f_getMinDate: function() {
		...
		minDate=f_core.GetAttribute(this, f_core._VNS+":minDate");
		if (minDate) {
	...
	f_getMaxDate: function() {
		...
		maxDate=f_core.GetAttribute(this, f_core._VNS+":maxDate");
		if (maxDate) {
