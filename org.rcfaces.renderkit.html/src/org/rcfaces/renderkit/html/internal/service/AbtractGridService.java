...
public abstract class AbtractGridService extends AbstractHtmlService {
    ...
    private static final Log LOG = LogFactory
            .getLog(AbtractGridService.class);
    ...
    protected abstract void writeElement(FacesContext facesContext,
			...
			AbstractGridRenderer gridRenderer, String rowValue, String rowIndex) throws WriterException ;
    ...
    private void decodeSubComponents(FacesContext facesContext,
        ...
        if(colIndex != null) {
        	...
        	UIColumn column = columnIterator.toArray()[Integer.parseInt(colIndex)];
