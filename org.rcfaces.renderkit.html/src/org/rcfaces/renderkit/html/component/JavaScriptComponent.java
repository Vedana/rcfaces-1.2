...
public class JavaScriptComponent extends CameliaBaseComponent implements
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "text",
                "srcCharSet", "requiredFiles", "src", "requiredClasses" }));
    }
    ...
    /**
     * Returns a string value sprecifying the charset associated to the "src"
     * files.
     * 
     * @return charset
     */
    ...
    /**
     * Sets a string value sprecifying the charset associated to the "src"
     * files.
     * 
     * @param srcCharSet
     *            charset
    ...
    public String getRequiredFiles(javax.faces.context.FacesContext facesContext) {
        return engine
                .getStringProperty(Properties.REQUIRED_FILES, facesContext);
    }
    ...
    /**
     * Returns a string value specifying a list of javascript classes to
     * include.
     * 
    ...
    public String getRequiredClasses(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.REQUIRED_CLASSES,
                facesContext);
    }
