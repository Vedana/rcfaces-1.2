 ...
 * </p>
 * <p>
 * It holds the included javascript and css files. It is responsible for
 * initializing RCFaces javascript engine.
 * </p>
 * <p>
 * It <b>must</b> be the first tag for a page.
 * </p>
 */
public class InitComponent extends CameliaBaseComponent implements
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "disableContextMenu", "waiRolesNS", "title",
                "clientMessageIdFilter", "clientValidation", "base",
                "literalTimeZone", "renderBaseTag", "disabledCookiesPageURL",
                "literalLocale", "disabledScriptPageURL",
                "invalidBrowserPageURL", "favoriteImageURL",
                "disabledIEImageBar", "disableCache" }));
    }
    ...
    /**
     * Returns a string value indicating the base HRef. If the key word
     * "context" is used the base HRef is calculated from the context.
     * 
     * @return base HRef
     */
    ...
    /**
     * Sets a string value indicating the base HRef. If the key word "context"
     * is used the base HRef is calculated from the context.
     * 
     * @param base
     *            base HRef
     */
    ...
    public final String getFavoriteImageURL(
        ...
        return engine.getStringProperty(Properties.FAVORITE_IMAGE_URL,
                facesContext);
    }
    ...
    /**
     * Returns an url string pointing to a page shown if scripts are not enabled
     * on the browser.
     * 
     * @return url
     */
    ...
    public final String getDisabledScriptPageURL(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.DISABLED_SCRIPT_PAGE_URL,
                facesContext);
    }

    /**
     * Sets an url string pointing to a page shown if scripts are not enabled on
     * the browser.
     * 
     * @param disabledScriptPageURL
     *            url
     */
    public final void setDisabledScriptPageURL(String disabledScriptPageURL) {
        engine.setProperty(Properties.DISABLED_SCRIPT_PAGE_URL,
                disabledScriptPageURL);
    }
     ...
     */
    /**
     * Returns <code>true</code> if the attribute "disabledScriptPageURL" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public final String getDisabledCookiesPageURL(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.DISABLED_COOKIES_PAGE_URL,
                facesContext);
    }
     ...
     * 
     * @param disabledCookiesPageURL
     *            true if cookies are to be disabled
     */
    public final void setDisabledCookiesPageURL(String disabledCookiesPageURL) {
        engine.setProperty(Properties.DISABLED_COOKIES_PAGE_URL,
     ...
     */
    /**
     * Returns <code>true</code> if the attribute "disabledCookiesPageURL" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    /**
     * Returns an url pointing to the page to show if the browser is not
     * supported.
     * 
     * @return url
     */
    ...
    public final String getInvalidBrowserPageURL(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.INVALID_BROWSER_PAGE_URL,
                facesContext);
    }
     ...
     * 
     * @param invalidBrowserPageURL
     *            url
     */
    public final void setInvalidBrowserPageURL(String invalidBrowserPageURL) {
        engine.setProperty(Properties.INVALID_BROWSER_PAGE_URL,
     ...
     */
    /**
     * Returns <code>true</code> if the attribute "invalidBrowserPageURL" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public final java.util.Locale getLiteralLocale(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.Locale) engine.getValue(Properties.LITERAL_LOCALE,
                facesContext);
    }
    ...
    public final java.util.TimeZone getLiteralTimeZone(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.TimeZone) engine.getValue(
    ...
    /**
     * Returns a boolean value specifying wether the "image Bar" (contextual
     * menu for images) in Internet Explorer should be hidden.
     * 
    ...
    public final boolean isDisabledIEImageBar(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.DISABLED_IEIMAGE_BAR, false,
                facesContext);
    }

    /**
     * Sets a boolean value specifying wether the "image Bar" (contextual menu
     * for images) in Internet Explorer should be hidden.
     * 
     * @param disabledIEImageBar
     *            true if the image bar is to be disabled
     */
    ...
    public final boolean isDisableCache(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.DISABLE_CACHE, false,
                facesContext);
    }
     ...
     * 
     * @param disableCache
     *            true if the cache is to be disabled
     */
    ...
    public final boolean isDisableContextMenu(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.DISABLE_CONTEXT_MENU, false,
                facesContext);
    }
     ...
     *            true if the browser context menu is to be hidden
     */
    ...
    public final boolean isRenderBaseTag(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.RENDER_BASE_TAG, true,
                facesContext);
    }
    ...
    public final String getClientMessageIdFilter(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.CLIENT_MESSAGE_ID_FILTER,
                facesContext);
    }

    public final void setClientMessageIdFilter(String clientMessageIdFilter) {
        engine.setProperty(Properties.CLIENT_MESSAGE_ID_FILTER,
                clientMessageIdFilter);
    }

    /**
     * Returns <code>true</code> if the attribute "clientMessageIdFilter" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public final boolean isClientValidation(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.CLIENT_VALIDATION, true,
                facesContext);
    }
