...
public class LoadClientBundleComponent extends CameliaBaseComponent {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "override",
                "baseName", "bundleName", "serverSide" }));
    }
    ...
    /**
     * Returns a string value specifying the name to be used on the client side
     * to access the resource bundle.
     * 
     * @return bundle name
     */
    ...
    /**
     * Sets a string value specifying the name to be used on the client side to
    ...
    /**
     * Returns a string indicating the fully qualified name of a resources
    ...
    /**
     * Sets a string indicating the fully qualified name of a resources bundle
     * (property file).
     * 
     * @param baseName
    ...
    /**
     * Returns a boolean value indicating wether the resource is available on
     * the server side.
     * 
    ...
    public boolean isServerSide(javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.SERVER_SIDE, false,
                facesContext);
    }

    /**
     * Sets a boolean value indicating wether the resource is available on the
     * server side.
     * 
     * @param serverSide
     *            true if the resource is available on the server side
     */
