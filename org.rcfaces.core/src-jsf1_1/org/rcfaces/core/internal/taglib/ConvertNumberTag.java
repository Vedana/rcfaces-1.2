...
public class ConvertNumberTag extends ConverterTag {
    ...
    protected Converter createConverter() throws JspException {
        ...
        if (currencyCode != null) {
            if (UIComponentTag.isValueReference(currencyCode)) {
                currencyCode = (String) evaluateValueBinding(facesContext,
                        currencyCode);
            }
        ...
        if (currencySymbol != null) {
            if (UIComponentTag.isValueReference(currencySymbol)) {
                currencySymbol = (String) evaluateValueBinding(facesContext,
                        currencySymbol);
            }
        ...
        if (pattern != null) {
            if (UIComponentTag.isValueReference(pattern)) {
                pattern = (String) evaluateValueBinding(facesContext,
                        pattern);
            }
        ...
        if (type != null) {
            if (UIComponentTag.isValueReference(type)) {
                type = (String) evaluateValueBinding(facesContext, type);
            }
        ...
        if (groupingUsed != null) {
            ...
            if (UIComponentTag.isValueReference(groupingUsed)) {
                Boolean b = (Boolean) evaluateValueBinding(facesContext,
                        groupingUsed);
                gu = b.booleanValue();
        ...
        if (maxFractionDigits != null) {
            ...
            if (UIComponentTag.isValueReference(maxFractionDigits)) {
                Integer i = (Integer) evaluateValueBinding(facesContext,
                        maxFractionDigits);
                mfd = i.intValue();
            } else {
        ...
        if (locale != null) {
            ...
            if (UIComponentTag.isValueReference(locale)) {
                loc = (Locale) evaluateValueBinding(facesContext, locale);
        ...
        if (result instanceof AbstractNumberConverter) {
            if (defaultValue != null) {
                ...
                if (UIComponentTag.isValueReference(defaultValue)) {
                    defValue = evaluateValueBinding(facesContext,
                            defaultValue);
                }
    ...
    private Object evaluateValueBinding(FacesContext facesContext,
            String value) {
