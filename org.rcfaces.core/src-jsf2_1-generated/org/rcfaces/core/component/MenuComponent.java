...
public class MenuComponent extends CameliaSelectManyComponent implements 
	...
	protected static final Collection<String> BEHAVIOR_EVENT_NAMES=CameliaSelectManyComponent.BEHAVIOR_EVENT_NAMES;
	...
	public String getMenuId(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.MENU_ID);
	}
	...
	public void setMenuId(String menuId) {
		 getStateHelper().put(Properties.MENU_ID, menuId);
	}
	...
	public boolean isMenuIdSetted() {
		return getStateHelper().get(Properties.MENU_ID)!=null;
	}
