...
public abstract class AbstractGridComponent extends CameliaGridComponent implements 
	...
	protected static final Collection<String> BEHAVIOR_EVENT_NAMES=CameliaGridComponent.BEHAVIOR_EVENT_NAMES;
	...
	public java.lang.String getSortManager(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.SORT_MANAGER);
	}
	...
	public final boolean isSortManagerSetted() {
		return getStateHelper().get(Properties.SORT_MANAGER)!=null;
	}

	public void setSortManager(java.lang.String sortManager) {
		getStateHelper().put(Properties.SORT_MANAGER, sortManager);
	}
	...
	public int getFirst(javax.faces.context.FacesContext facesContext) {
		return (Integer)getStateHelper().eval(Properties.FIRST, 0);
	}

	public void setFirst(int first) {
		 getStateHelper().put(Properties.FIRST, first);
	}
	...
	public boolean isFirstSetted() {
		return getStateHelper().get(Properties.FIRST)!=null;
	}
	...
	public int getRows(javax.faces.context.FacesContext facesContext) {
		return (Integer)getStateHelper().eval(Properties.ROWS, 0);
	}
	...
	public boolean isRowsSetted() {
		return getStateHelper().get(Properties.ROWS)!=null;
	}
