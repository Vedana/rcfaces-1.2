...
public class TimeEntryComponent extends AbstractInputComponent implements 
	...
	public Time getMinTime(javax.faces.context.FacesContext facesContext) {
		return (Time)getStateHelper().eval(Properties.MIN_TIME);
	}
	...
	public void setMinTime(Time minTime) {
		 getStateHelper().put(Properties.MIN_TIME, minTime);
	}
	...
	public boolean isMinTimeSetted() {
		return getStateHelper().get(Properties.MIN_TIME)!=null;
	}
	...
	public Time getDefaultTime(javax.faces.context.FacesContext facesContext) {
		return (Time)getStateHelper().eval(Properties.DEFAULT_TIME);
	}
	...
	public void setDefaultTime(Time defaultTime) {
		 getStateHelper().put(Properties.DEFAULT_TIME, defaultTime);
	}
	...
	public boolean isDefaultTimeSetted() {
		return getStateHelper().get(Properties.DEFAULT_TIME)!=null;
	}
	...
	public Time getMaxTime(javax.faces.context.FacesContext facesContext) {
		return (Time)getStateHelper().eval(Properties.MAX_TIME);
	}
	...
	public void setMaxTime(Time maxTime) {
		 getStateHelper().put(Properties.MAX_TIME, maxTime);
	}
	...
	public boolean isMaxTimeSetted() {
		return getStateHelper().get(Properties.MAX_TIME)!=null;
	}
	...
	public String getTimeFormat(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.TIME_FORMAT);
	}

	public void setTimeFormat(String timeFormat) {
		 getStateHelper().put(Properties.TIME_FORMAT, timeFormat);
	}
	...
	public boolean isTimeFormatSetted() {
		return getStateHelper().get(Properties.TIME_FORMAT)!=null;
	}
	...
	public String getHourStep(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.HOUR_STEP);
	}
	...
	public void setHourStep(String hourStep) {
		 getStateHelper().put(Properties.HOUR_STEP, hourStep);
	}
	...
	public boolean isHourStepSetted() {
		return getStateHelper().get(Properties.HOUR_STEP)!=null;
	}
	...
	public String getMinuteStep(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.MINUTE_STEP);
	}
	...
	public void setMinuteStep(String minuteStep) {
		 getStateHelper().put(Properties.MINUTE_STEP, minuteStep);
	}
	...
	public boolean isMinuteStepSetted() {
		return getStateHelper().get(Properties.MINUTE_STEP)!=null;
	}
	...
	public String getSecondStep(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.SECOND_STEP);
	}
	...
	public void setSecondStep(String secondStep) {
		 getStateHelper().put(Properties.SECOND_STEP, secondStep);
	}
	...
	public boolean isSecondStepSetted() {
		return getStateHelper().get(Properties.SECOND_STEP)!=null;
	}
	...
	public String getMillisStep(javax.faces.context.FacesContext facesContext) {
		return (String)getStateHelper().eval(Properties.MILLIS_STEP);
	}
	...
	public void setMillisStep(String millisStep) {
		 getStateHelper().put(Properties.MILLIS_STEP, millisStep);
	}
	...
	public boolean isMillisStepSetted() {
		return getStateHelper().get(Properties.MILLIS_STEP)!=null;
	}
