...
public class TextAreaComponent extends AbstractInputComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"focusStyleClass","text","fatalStyleClass","styleClass","rowNumber","columnNumber","textDirection","emptyMessage","selectionListener","maxTextLength","valueChangeListener","readOnly","errorStyleClass","warnStyleClass","alternateText","infoStyleClass","required"}));
	}
