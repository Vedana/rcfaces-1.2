 ...
 * </table>
 */
public class ExternalBoxComponentXX extends AbstractOutputComponent implements 
	ILoadEventCapability,
	IOverStyleClassCapability {

	private static final Log LOG = LogFactory.getLog(ExternalBoxComponentXX.class);
	...
	public ExternalBoxComponentXX() {
		setRendererType(COMPONENT_TYPE);
	}

	public ExternalBoxComponentXX(String componentId) {
		this();
		setId(componentId);
	}
