...
public class KeyLabelComponentXX extends AbstractOutputComponent implements 
	IFilterCapability {

	private static final Log LOG = LogFactory.getLog(KeyLabelComponentXX.class);
	...
	public KeyLabelComponentXX() {
		setRendererType(COMPONENT_TYPE);
	}

	public KeyLabelComponentXX(String componentId) {
		this();
		setId(componentId);
	}
