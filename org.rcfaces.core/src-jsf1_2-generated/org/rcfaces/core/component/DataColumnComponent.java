...
public class DataColumnComponent extends CameliaValueColumnComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"selectionListener","defaultCellImageURL","imageURL","width","verticalAlignment","defaultCellStyleClass","doubleClickListener","alignment","hiddenMode","cellImageURL","foregroundColor","menuPopupId","styleClass","sortListener","sortComparator","initListener","selectedImageURL","value","hoverImageURL","imageHeight","maxWidth","disabledImageURL","ascending","toolTipText","userEventListener","cellToolTipText","minWidth","textDirection","resizable","text","imageWidth","cellStyleClass","cellDefaultToolTipText","visible","backgroundColor","autoFilter"}));
	}
