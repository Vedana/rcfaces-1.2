...
public abstract class AbstractOutputComponent extends CameliaOutputComponent implements 
	...
	static {
<<<<<<< HEAD
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"bottomPosition","visible","marginLeft","backgroundColor","errorListener","leftPosition","propertyChangeListener","helpURL","ariaLevel","topPosition","height","valueLocked","hiddenMode","mouseOverListener","foregroundColor","waiRole","mouseOutListener","lookId","rightPosition","helpMessage","userEventListener","marginTop","styleClass","marginRight","width","partialRendering","ariaLabel","initListener","unlockedClientAttributeNames","marginBottom","toolTipText","y","margins","x"}));
=======
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"visible","marginLeft","backgroundColor","errorListener","propertyChangeListener","helpURL","ariaLevel","height","valueLocked","hiddenMode","mouseOverListener","left","right","mouseOutListener","foregroundColor","waiRole","top","lookId","helpMessage","userEventListener","marginTop","styleClass","marginRight","width","partialRendering","ariaLabel","initListener","verticalCenter","unlockedClientAttributeNames","marginBottom","bottom","toolTipText","y","horizontalCenter","margins","x"}));
