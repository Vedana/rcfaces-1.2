...
public abstract class AbstractOutputComponent extends CameliaOutputComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"visible","marginLeft","backgroundColor","errorListener","propertyChangeListener","helpURL","ariaLevel","height","valueLocked","hiddenMode","mouseOverListener","foregroundColor","waiRole","mouseOutListener","lookId","helpMessage","userEventListener","marginTop","styleClass","marginRight","width","partialRendering","initListener","marginBottom","unlockedClientAttributeNames","toolTipText","y","margins","x"}));
	}
