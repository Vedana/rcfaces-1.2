...
public abstract class AbstractMessagesComponent extends CameliaMessagesComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"width","unlockedClientAttributeNames","marginRight","hiddenMode","helpMessage","foregroundColor","styleClass","height","globalOnly","margins","initListener","propertyChangeListener","mouseOutListener","ariaLevel","waiRole","mouseOverListener","toolTipText","showDetail","userEventListener","helpURL","marginBottom","partialRendering","showSummary","y","visible","lookId","marginLeft","marginTop","errorListener","backgroundColor","x"}));
	}
