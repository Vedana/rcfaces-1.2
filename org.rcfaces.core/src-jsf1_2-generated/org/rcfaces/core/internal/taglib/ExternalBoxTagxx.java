...
import org.rcfaces.core.component.ExternalBoxComponentXX;
import org.rcfaces.core.internal.tools.ListenersTools;
import javax.faces.context.FacesContext;

public class ExternalBoxTagxx extends AbstractOutputTag implements Tag {


	private static final Log LOG=LogFactory.getLog(ExternalBoxTagxx.class);
	...
	public String getComponentType() {
		return ExternalBoxComponentXX.COMPONENT_TYPE;
	}
	...
	protected void setProperties(UIComponent uiComponent) {
		if (LOG.isDebugEnabled()) {
			if (ExternalBoxComponentXX.COMPONENT_TYPE==getComponentType()) {
		...
		if ((uiComponent instanceof ExternalBoxComponentXX)==false) {
		...
		ExternalBoxComponentXX component = (ExternalBoxComponentXX) uiComponent;
