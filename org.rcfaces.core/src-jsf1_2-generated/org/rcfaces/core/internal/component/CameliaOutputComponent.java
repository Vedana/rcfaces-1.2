 ...
 */
public abstract class CameliaOutputComponent extends
        javax.faces.component.UIOutput implements IRCFacesComponent,
        IContainerManager, IComponentLifeCycle, ITransientAttributesManager,
        IConvertValueHolder {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaOutputComponent.class);

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            Arrays.asList(new String[] { "converter", "value" }));
    ...
    public final String getRendererType() {
        ...
        if (rendererType == null) {
            if (LOG.isTraceEnabled()) {
                LOG.trace("RendererType is null for component id='" + getId()
                        + "' class='" + getClass() + "'");
            }
            return null;
        }
    ...
    public void restoreState(FacesContext context, Object state) {
        ...
        try {
            ...
            LOG.error("Can not restore state of component '" + getId() + "'.",
                    ex);
    ...
    /*
     * public void release() { if (engine != null) { engine.release(); } }
     */
    ...
    public void encodeChildren(FacesContext context) throws IOException {
        ...
        try {
            ...
            LOG.error(
                    "Can not encode children of component '" + getId() + "'.",
                    ex);
    ...
    protected boolean verifyAsyncDecode(FacesContext context, PhaseId phaseId) {
        return ComponentTools.verifyAsyncDecode(context,
                (IAsyncDecodeModeCapability) this, phaseId);
    }
    ...
    public void processDecodes(FacesContext context) {
        ...
        try {
            ...
            if (this instanceof IVariableScopeCapability) {
                varScope = BindingTools.processVariableScope(context,
                        (IVariableScopeCapability) this,
            ...
            if (immediate) {
                if (ComponentTools
                        .hasValidationServerListeners(getFacesListeners(IValidationListener.class))) {
    ...
    public void processValidators(FacesContext context) {
        if (context == null) {
            throw new NullPointerException(
                    "Context is NULL to processValidators");
        }
    ...
    public final int getChildrenListState() {
        if (Constants.STATED_COMPONENT_CHILDREN_LIST == false) {
            throw new UnsupportedOperationException(
                    "STATED_COMPONENT_CHILDREN_LIST=false");
        }
    ...
    public boolean confirmListenerAppend(FacesContext facesContext,
