...
public class MessageDialogComponent extends CameliaInputComponent implements
        IImageCapability, IStyleClassCapability, ITextCapability,
        ITextDirectionCapability, IVisibilityCapability,
        IDialogPriorityCapability, IImmediateCapability,
        IValidationEventCapability, ISizeCapability, IHiddenModeCapability,
        ILookAndFeelCapability, IWAIRoleCapability, ISelectionEventCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "imageURL", "width", "defaultValue",
                "validationListener", "title", "waiRole", "hiddenMode",
                "textDirection", "styleClass", "text", "height",
                "dialogPriority", "immediate", "visible", "lookId" }));
    }
    ...
    public int getDialogPriority(javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.DIALOG_PRIORITY, 0,
                facesContext);
    }
