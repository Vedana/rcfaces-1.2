...
public class MessageDialogComponent extends CameliaInputComponent implements
        ...
        IDialogPriorityCapability, IImmediateCapability, ISizeCapability,
        IHiddenModeCapability, ILookAndFeelCapability, IWAIRoleCapability,
        ISelectionEventCapability, IImageAccessorsCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                ...
                "title", "waiRole", "hiddenMode", "textDirection",
                "styleClass", "text", "height", "dialogPriority", "immediate",
                "visible", "lookId" }));
    }
