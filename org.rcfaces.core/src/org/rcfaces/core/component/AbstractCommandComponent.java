 ...
 */
public abstract class AbstractCommandComponent extends CameliaCommandComponent
        ...
        IStyleClassCapability, IServerDataCapability, IFontCapability,
        IInitEventCapability, IHelpCapability, IClientDataCapability,
        ITabIndexCapability, IPositionCapability, ILookAndFeelCapability,
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaCommandComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "fontUnderline",
                "width", "unlockedClientAttributeNames", "marginRight",
                "fontSize", "hiddenMode", "foregroundColor", "helpMessage",
                "styleClass", "height", "margins", "initListener",
                "propertyChangeListener", "mouseOutListener", "blurListener",
                "fontName", "focusListener", "validationListener", "waiRole",
                "disabled", "mouseOverListener", "toolTipText", "accessKey",
                "userEventListener", "marginBottom", "helpURL", "fontItalic",
                "fontBold", "textAlignment", "immediate", "visible", "y",
                "marginLeft", "lookId", "marginTop", "backgroundColor",
                "errorListener", "tabIndex", "x" }));
    }
