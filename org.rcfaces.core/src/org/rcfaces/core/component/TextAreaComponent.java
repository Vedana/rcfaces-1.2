...
/**
 * <p>
 * The textAreaEntry Component is based on the standard HTML tag
 * &lt;TEXTAREA&gt; and is a <a href="/comps/textEntryComponent.html">textEntry
 * Component</a>.
 * </p>
 * <p>
...
public class TextAreaComponent extends AbstractInputComponent implements
        ...
        ISelectionEventCapability, IAlternateTextCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "errorStyleClass", "selectionListener", "fatalStyleClass",
                "required", "valueChangeListener", "columnNumber",
                "warnStyleClass", "textDirection", "alternateText",
                "styleClass", "text", "rowNumber", "infoStyleClass",
                "readOnly", "focusStyleClass", "emptyMessage" }));
    }
