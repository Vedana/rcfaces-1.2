...
public class TextAreaComponent extends AbstractInputComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"errorStyleClass","selectionListener","fatalStyleClass","required","valueChangeListener","columnNumber","warnStyleClass","textDirection","alternateText","styleClass","text","rowNumber","infoStyleClass","readOnly","focusStyleClass","emptyMessage"}));
	}
