...
public class ViewDialogComponent extends CameliaOutputComponent implements
        ...
        IDialogPriorityCapability, ISizeCapability, IHiddenModeCapability,
        ILookAndFeelCapability, IWAIRoleCapability, IImageAccessorsCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "styleClass",
                "width", "text", "imageURL", "height", "dialogPriority",
                "waiRole", "visible", "hiddenMode", "lookId", "viewURL",
                "textDirection" }));
    }
