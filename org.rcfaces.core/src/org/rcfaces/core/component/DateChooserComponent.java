...
public class DateChooserComponent extends AbstractCalendarComponent implements
        IImageButtonFamilly, IValueChangeEventCapability {
    ...
    public final void setHomeDate(String date) {
        ...
        setHomeDate((Date) DateConverter.SINGLETON
                .getAsObject(null, this, date));
    ...
    public final java.util.Date getHomeDate(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.Date) engine.getValue(Properties.HOME_DATE,
                facesContext);
    }
