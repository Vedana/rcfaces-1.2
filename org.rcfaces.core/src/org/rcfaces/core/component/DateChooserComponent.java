...
/**
 * <p>
 * The dateChooser Component is a button that shows a calendar and help the user
 * to choose a date. It can be associated to a entry field, the choosen date is
 * then automatically entered in the field. It works like an <a
 * href="/comps/imageButtonComponent.html">Image Button Component</a>. The
 * dateChooser Component does <b>not</b> provide an Entry field.
 * </p>
 * <p>
...
public class DateChooserComponent extends AbstractCalendarComponent implements
        IImageButtonFamilly, IValueChangeEventCapability, IForCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                ...
                "imageURL", "disabledImageURL", "disabled",
                "valueChangeListener", "homeDate", "homeDateLabel", "text",
                "imageWidth", "selectedImageURL", "border", "forValueFormat",
                "borderType", "readOnly", "textPosition", "for" }));
    }
    ...
    /**
     * Returns a string specifying the format to use for the value that will be
     * send to the component specified in the <b>for</b> property.
     * 
     * @return value format
     */
    ...
    public final String getForValueFormat(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.FOR_VALUE_FORMAT,
                facesContext);
    }

    /**
     * Sets a string specifying the format to use for the value that will be
     * send to the component specified in the <b>for</b> property.
     * 
     * @param forValueFormat
     *            value format
     */
    ...
    public final String getHomeDateLabel(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.HOME_DATE_LABEL,
                facesContext);
    }
