...
public class DateEntryComponent extends AbstractCalendarComponent implements
        ...
        IFocusStyleClassCapability, IValidationParameters {
    ...
    public final void setDefaultDate(String date) {
        ...
        setDefaultDate((Date) DateConverter.SINGLETON.getAsObject(null, this,
                date));
    ...
    public final java.util.Date getDefaultDate(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.Date) engine.getValue(Properties.DEFAULT_DATE,
                facesContext);
    }
