...
public class ToolItemComponent extends UIImageItemComponent implements
        IRadioGroupCapability, IInputTypeCapability, IImageSizeCapability,
        ILookAndFeelCapability, IBorderTypeCapability, ITextPositionCapability,
        IAccessKeyCapability, IWidthCapability, IStyleClassCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "styleClass",
                "imageHeight", "width", "inputType", "imageWidth", "accessKey",
                "borderType", "lookId", "groupName", "textPosition" }));
    }
    ...
    public void setInputType(String inputType) {
        ...
        setInputType(((Integer) InputTypeConverter.SINGLETON.getAsObject(null,
