...
public class ComboGridComponent extends AbstractGridComponent implements
        ISelectionEventCapability, IAdditionalInformationEventCapability,
        IAdditionalInformationValuesCapability,
        IClientAdditionalInformationFullStateCapability,
        IAdditionalInformationCardinalityCapability, IDisabledCapability,
        IRequiredCapability, IReadOnlyCapability, IBorderCapability,
        IRowStyleClassCapability, IPagerMessageCapability,
        IMaxTextLengthCapability, IScrollableCapability, IFilterCapability,
        IPagedCapability, IHeaderVisibilityCapability,
        IOrderedChildrenCapability, IAdditionalInformationRangeComponent,
        IGridComponent, IComponentValueTypeCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "popupHeight",
                "selectionListener", "suggestionDelayMs",
                "horizontalScrollPosition", "pagerStyleClass", "message",
                "clientAdditionalInformationFullState", "rowIndexVar",
                "valueColumnId", "additionalInformationValues", "pagerLookId",
                "oneResultMessage", "filterProperties", "zeroResultMessage",
                "additionalInformationListener", "valueFormat", "border",
                "gridStyleClass", "labelColumnId", "suggestionMinChars",
                "gridLookId", "verticalScrollPosition", "paged", "required",
                "disabled", "selectedValue", "maxTextLength",
                "additionalInformationCardinality", "rowStyleClass",
                "headerVisible", "rowCountVar", "manyResultsMessage",
                "popupWidth", "readOnly" }));
    }
