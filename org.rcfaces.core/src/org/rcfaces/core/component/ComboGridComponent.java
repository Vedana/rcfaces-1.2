...
public class ComboGridComponent extends AbstractGridComponent implements
        ISelectionEventCapability, IDisabledCapability, IRequiredCapability,
        IReadOnlyCapability, IBorderCapability, IRowStyleClassCapability,
        IPagerMessageCapability, IScrollableCapability, IFilterCapability,
        IPagedCapability, IHeaderVisibilityCapability,
        IOrderedChildrenCapability, IGridComponent, ISortedChildrenCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays
                .asList(new String[] { "selectionListener", "popupHeight",
                        "suggestionDelayMs", "horizontalScrollPosition",
                        "pagerStyleClass", "message", "rowIndexVar",
                        "valueColumnId", "pagerLookId", "filterProperties",
                        "oneResultMessage", "zeroResultMessage", "border",
                        "valueFormat", "gridStyleClass", "suggestionMinChars",
                        "labelColumnId", "gridLookId",
                        "verticalScrollPosition", "paged", "required",
                        "disabled", "selectedValue", "rowStyleClass",
