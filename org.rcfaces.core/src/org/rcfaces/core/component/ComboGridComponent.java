...
public class ComboGridComponent extends AbstractGridComponent implements
        IDisabledCapability, IRequiredCapability, IReadOnlyCapability,
        IBorderCapability, IRowStyleClassCapability, IPagerMessageCapability,
        IScrollableCapability, IPagedCapability, IOrderedChildrenCapability,
        IGridComponent, ISortedChildrenCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "popupHeight",
                "selectionValueConverter", "suggestionDelayMs",
                "horizontalScrollPosition", "message", "pagerStyleClass",
                "rowIndexVar", "valueColumnId", "pagerLookId",
                "oneResultMessage", "zeroResultMessage", "border",
                "valueFormat", "gridStyleClass", "suggestionMinChars",
                "labelColumnId", "gridLookId", "verticalScrollPosition",
                "paged", "required", "disabled", "selectedValue",
                "rowStyleClass", "rowCountVar", "manyResultsMessage",
                "popupWidth", "readOnly" }));
    }
    ...
    public final IColumnIterator listColumns() {
        ...
        return GridTools
                .listColumns(this, javax.faces.component.UIColumn.class);
    ...
    public final ComboColumnComponent getFirstSortedColumn() {
        ...
        return (ComboColumnComponent) SortTools.getFirstSortedChild(null, this,
    ...
    public final void setSortedColumn(ComboColumnComponent comboColumn) {
        ...
        SortTools.setSortedChildren(null, this, engine,
                ComboColumnComponent.class,
                new ComboColumnComponent[] { comboColumn });
    ...
    /**
     * See {@link #getManyResultsMessage() getManyResultsMessage()} for more
     * details
     */
    public java.lang.String getManyResultsMessage(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.MANY_RESULTS_MESSAGE,
                facesContext);
    }
    ...
    public java.lang.String getOneResultMessage(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.ONE_RESULT_MESSAGE,
                facesContext);
    }
    ...
    /**
     * See {@link #getZeroResultMessage() getZeroResultMessage()} for more
     * details
     */
    public java.lang.String getZeroResultMessage(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.ZERO_RESULT_MESSAGE,
                facesContext);
    }
    ...
    /**
     * Returns an int value specifying the delay in milliseconds before showing
     * the suggestion list.
     * 
    ...
    /**
     * Sets an int value specifying the delay in milliseconds before showing the
     * suggestion list.
     * 
     * @param suggestionDelayMs
    ...
    /**
     * Returns an int value specifying the minimum number of characters before
     * the suggestion is calculated.
     * 
    ...
    /**
     * Sets an int value specifying the minimum number of characters before the
     * suggestion is calculated.
     * 
     * @param suggestionMinChars
    ...
    public final String getValueColumnId(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.VALUE_COLUMN_ID,
                facesContext);
    }
    ...
    public final String getLabelColumnId(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.LABEL_COLUMN_ID,
                facesContext);
    }
    ...
    public final javax.faces.convert.Converter getSelectionValueConverter(
        ...
        return (javax.faces.convert.Converter) engine.getValue(
                Properties.SELECTION_VALUE_CONVERTER, facesContext);
    }

    public final void setSelectionValueConverter(
            javax.faces.convert.Converter selectionValueConverter) {
        engine.setProperty(Properties.SELECTION_VALUE_CONVERTER,
                selectionValueConverter);
    }

    /**
     * Returns <code>true</code> if the attribute "selectionValueConverter" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public final String getPagerStyleClass(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.PAGER_STYLE_CLASS,
                facesContext);
    }
    ...
    public final String getGridStyleClass(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.GRID_STYLE_CLASS,
                facesContext);
    }
