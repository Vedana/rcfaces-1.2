 ...
 */
public abstract class AbstractCalendarComponent extends AbstractInputComponent
        implements ISelectionEventCapability, IReadOnlyCapability,
        ILiteralLocaleCapability, ILiteralTimeZoneCapability,
        IComponentLocaleCapability, IComponentTimeZoneCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "literalTimeZone", "maxDate",
                "literalLocale", "componentLocale", "clientDatesStrategy",
                "componentTimeZone", "readOnly", "disabledWeekDays",
                "twoDigitYearStart", "minDate" }));
    }
    ...
    public Date getDate() {
        ...
        throw new FacesException("Value of AbstractCalendar is not a date ! ("
                + value + ")");
    ...
    public Date getTwoDigitYearStart(FacesContext facesContext) {
        ...
        Object value = engine.getProperty(Properties.TWO_DIGIT_YEAR_START,
                facesContext);
        if (value instanceof String) {
            value = LiteralTwoDigitYearConverter.SINGLETON.getAsObject(
                    facesContext, this, (String) value);
        }
    ...
    public void setClientDatesStrategy(String strategy) {
        ...
        setClientDatesStrategy(((Integer) ClientDatesStrategyConverter.SINGLETON
                .getAsObject(null, this, strategy)).intValue());
    ...
    public Date getMinDate(FacesContext facesContext) {
        ...
        if (value instanceof String) {
            value = LiteralDateConverter.SINGLETON.getAsObject(facesContext,
                    this, (String) value);
        }
    ...
    public void setDisabledWeekDays(String disabledWeekDays) {
        ...
        setDisabledWeekDays(((Integer) WeekDaysConverter.SINGLETON.getAsObject(
                null, this, disabledWeekDays)).intValue());
    ...
    /**
     * See {@link #getClientDatesStrategy() getClientDatesStrategy()} for more
     * details
     */
    public int getClientDatesStrategy(
            javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.CLIENT_DATES_STRATEGY, 0,
                facesContext);
    }

    /**
     * Returns <code>true</code> if the attribute "clientDatesStrategy" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public void setClientDatesStrategy(int clientDatesStrategy) {
        engine.setProperty(Properties.CLIENT_DATES_STRATEGY,
                clientDatesStrategy);
    }

    /**
     * Returns a string value specifying the year considered as base for
     * selecting a date when the associated dateEntry's value's year has only
     * two digits.
     * 
     * @return pivot year
     */
    ...
    /**
     * Sets a string value specifying the year considered as base for selecting
     * a date when the associated dateEntry's value's year has only two digits.
     * 
     * @param twoDigitYearStart
     *            pivot year
     */
    ...
    /**
     * Returns a date value indicating the minimum acceptable date for the
     * component. the first accepted value is minDate plus one day.
     * 
     * @return min date
     */
    ...
    /**
     * Sets a date value indicating the minimum acceptable date for the
     * component. the first accepted value is minDate plus one day.
     * 
     * @param minDate
     *            min date
    ...
    /**
     * Returns a date value indicating the maximum acceptable date for the
     * component. The last accepted value is maxDate minus one day.
     * 
     * @return max date
     */
    ...
    /**
     * Sets a date value indicating the maximum acceptable date for the
     * component. The last accepted value is maxDate minus one day.
     * 
     * @param maxDate
     *            max date
    ...
    /**
     * Returns a list of disabled week days (depending on the locale specified
     * for the component).
     * 
     * @return list of days
     */
    ...
    public int getDisabledWeekDays(javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.DISABLED_WEEK_DAYS, 0,
                facesContext);
    }

    /**
     * Sets a list of disabled week days (depending on the locale specified for
     * the component).
     * 
     * @param disabledWeekDays
     *            list of days
     */
