 ...
 */
public abstract class AbstractBasicComponent extends CameliaBaseComponent
        implements IClientDataCapability, IServerDataCapability,
        IPropertyChangeEventCapability, IUserEventCapability,
        IErrorEventCapability, IWAIRoleCapability, IPositionCapability,
        ISizeCapability, IMarginCapability, IHelpCapability,
        IForegroundBackgroundColorCapability, IVisibilityCapability,
        IHiddenModeCapability, ILookAndFeelCapability, IStyleClassCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "width",
                "waiRole", "marginRight", "toolTipText", "hiddenMode",
                "foregroundColor", "userEventListener", "helpMessage",
                "helpURL", "marginBottom", "styleClass", "height", "margins",
                "visible", "y", "propertyChangeListener", "lookId",
                "marginLeft", "marginTop", "backgroundColor", "errorListener",
                "x" }));
    }
