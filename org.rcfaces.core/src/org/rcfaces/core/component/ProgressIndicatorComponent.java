...
/**
 * <p>
 * The progressIndicator Component indicates the evolution of a task. It uses
 * the <a href="/comps/progressBarComponent.html">porgressBar Component</a> and
 * add text information to it.
 * </p>
 * <p>
 * The progressIndicator Component has the following capabilities :
 * <ul>
 * <li>Position &amp; Size</li>
 ...
 * </p>
 */
public class ProgressIndicatorComponent extends AbstractBasicComponent
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays
                .asList(new String[] { "indeterminate" }));
    }
    ...
    public ProgressIndicatorComponent() {
        ...
        if (Constants.TEMPLATE_ENGINE_SUPPORT == false) {
            throw new FacesException(
                    "Template Support must be enabled to use this component !");
        }
    }
    ...
    public boolean isIndeterminate(javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.INDETERMINATE, false,
                facesContext);
    }
