...
public abstract class AbstractSelectManyComponent extends
        ...
        ILookAndFeelCapability, IPositionCapability, IMarginCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "fontUnderline",
                ...
                "waiRole", "keyUpListener", "disabled", "mouseOverListener",
                "toolTipText", "accessKey", "userEventListener",
                "marginBottom", "helpURL", "fontItalic", "fontBold",
                "textAlignment", "immediate", "y", "visible", "marginLeft",
                "lookId", "marginTop", "tabIndex", "valueLocked",
