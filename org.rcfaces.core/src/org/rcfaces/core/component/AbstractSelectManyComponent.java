 ...
 */
public abstract class AbstractSelectManyComponent extends
        CameliaSelectManyComponent implements IVisibilityCapability,
        ISizeCapability, IMouseEventCapability, IDisabledCapability,
        IUnlockedClientAttributesCapability, IFocusBlurEventCapability,
        IErrorEventCapability, IForegroundBackgroundColorCapability,
        IKeyEventCapability, IStyleClassCapability, IServerDataCapability,
        IFontCapability, IInitEventCapability, IHelpCapability,
        IClientDataCapability, IValueLockedCapability, ITabIndexCapability,
        ILookAndFeelCapability, IPositionCapability,
        IValidationEventCapability, IMarginCapability,
        ITextAlignmentCapability, IImmediateCapability, IUserEventCapability,
        IHiddenModeCapability, IWAIRoleCapability,
        IPropertyChangeEventCapability, IAccessKeyCapability,
        IServerDataManager, IClientDataManager {

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaSelectManyComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "fontUnderline",
                "width", "unlockedClientAttributeNames", "keyPressListener",
                "marginRight", "fontSize", "hiddenMode", "foregroundColor",
                "helpMessage", "styleClass", "height", "margins",
                "initListener", "propertyChangeListener", "mouseOutListener",
                "blurListener", "keyDownListener", "fontName", "focusListener",
                "validationListener", "waiRole", "keyUpListener", "disabled",
                "mouseOverListener", "toolTipText", "accessKey",
                "userEventListener", "marginBottom", "helpURL", "fontItalic",
                "fontBold", "textAlignment", "immediate", "y", "visible",
                "marginLeft", "lookId", "marginTop", "tabIndex", "valueLocked",
                "backgroundColor", "errorListener", "x" }));
    }
    ...
    /**
     * See
     * {@link #getUnlockedClientAttributeNames() getUnlockedClientAttributeNames()}
     * for more details
     */
    public java.lang.String getUnlockedClientAttributeNames(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(
                Properties.UNLOCKED_CLIENT_ATTRIBUTE_NAMES, facesContext);
    }

    /**
     * Returns <code>true</code> if the attribute
     * "unlockedClientAttributeNames" is set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    public final boolean isUnlockedClientAttributeNamesSetted() {
        return engine
                .isPropertySetted(Properties.UNLOCKED_CLIENT_ATTRIBUTE_NAMES);
    }

    public void setUnlockedClientAttributeNames(
            java.lang.String unlockedClientAttributeNames) {
        engine.setProperty(Properties.UNLOCKED_CLIENT_ATTRIBUTE_NAMES,
    ...
    public final void addErrorListener(
            org.rcfaces.core.event.IErrorListener listener) {
        addFacesListener(listener);
    }
    ...
    public final void addKeyPressListener(
            org.rcfaces.core.event.IKeyPressListener listener) {
        addFacesListener(listener);
    }

    public final void removeKeyPressListener(
            org.rcfaces.core.event.IKeyPressListener listener) {
        removeFacesListener(listener);
    }
    ...
    public final void addKeyDownListener(
            org.rcfaces.core.event.IKeyDownListener listener) {
        addFacesListener(listener);
    }

    public final void removeKeyDownListener(
            org.rcfaces.core.event.IKeyDownListener listener) {
        removeFacesListener(listener);
    }
    ...
    public final void addKeyUpListener(
            org.rcfaces.core.event.IKeyUpListener listener) {
        addFacesListener(listener);
    }

    public final void removeKeyUpListener(
            org.rcfaces.core.event.IKeyUpListener listener) {
        removeFacesListener(listener);
    }
    ...
    public final void addUserEventListener(
            org.rcfaces.core.event.IUserEventListener listener) {
        addFacesListener(listener);
    }

    public final void removeUserEventListener(
            org.rcfaces.core.event.IUserEventListener listener) {
        removeFacesListener(listener);
    }
