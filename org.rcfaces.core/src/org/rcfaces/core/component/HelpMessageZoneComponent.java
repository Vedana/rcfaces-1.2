...
/**
 * <p>
 * The helpMessageZone Component is a placeholder for help messages. The
 * messages are shown when the pointer hover a component and this component has
 * a "helpMessage" property.
 * </p>
 * <p>
...
public class HelpMessageZoneComponent extends AbstractOutputComponent implements
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "fontBold",
                "fontUnderline", "text", "textAlignment", "fontSize",
                "fontName", "fontItalic", "textDirection" }));
    }
