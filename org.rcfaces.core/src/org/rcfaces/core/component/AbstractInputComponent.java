 ...
 */
public abstract class AbstractInputComponent extends CameliaInputComponent
        implements ISizeCapability, IVisibilityCapability,
        IMouseEventCapability, IDisabledCapability,
        IUnlockedClientAttributesCapability, IFocusBlurEventCapability,
        IErrorEventCapability, IKeyEventCapability,
        IForegroundBackgroundColorCapability, IStyleClassCapability,
        IServerDataCapability, IFontCapability, IInitEventCapability,
        IHelpCapability, IClientDataCapability, IValueLockedCapability,
        ITabIndexCapability, ILookAndFeelCapability, IPositionCapability,
        IValidationEventCapability, IMarginCapability,
        ITextAlignmentCapability, IImmediateCapability, IUserEventCapability,
        IWAIRoleCapability, IHiddenModeCapability,
