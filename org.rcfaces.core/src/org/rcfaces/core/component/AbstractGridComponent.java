 ...
 */
public abstract class AbstractGridComponent extends CameliaGridComponent
        implements IVisibilityCapability, ISizeCapability, IHelpCapability,
        IMouseEventCapability, IClientDataCapability,
        IUnlockedClientAttributesCapability, ILookAndFeelCapability,
        IFocusBlurEventCapability, IPositionCapability, IErrorEventCapability,
        IMarginCapability, IForegroundBackgroundColorCapability,
        IKeyEventCapability, IResetEventCapability, IStyleClassCapability,
        IUserEventCapability, IServerDataCapability, IHiddenModeCapability,
        IWAIRoleCapability, IPropertyChangeEventCapability,
        IInitEventCapability, IServerDataManager, IClientDataManager {
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaGridComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "width",
                "unlockedClientAttributeNames", "keyPressListener",
                "marginRight", "hiddenMode", "helpMessage", "foregroundColor",
                "styleClass", "height", "margins", "initListener",
                "propertyChangeListener", "mouseOutListener", "blurListener",
                "resetListener", "keyDownListener", "var", "rows",
                "focusListener", "waiRole", "keyUpListener", "first",
                "mouseOverListener", "toolTipText", "userEventListener",
                "helpURL", "marginBottom", "visible", "y", "lookId",
                "marginLeft", "marginTop", "errorListener", "backgroundColor",
                "x" }));
    }
    ...
    public final void addResetListener(
            org.rcfaces.core.event.IResetListener listener) {
        addFacesListener(listener);
    }

    public final void removeResetListener(
            org.rcfaces.core.event.IResetListener listener) {
        removeFacesListener(listener);
    }
