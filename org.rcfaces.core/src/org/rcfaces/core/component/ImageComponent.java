...
public class ImageComponent extends AbstractOutputComponent implements
        IImageCapability, IImageSizeCapability, IFilterCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "imageHeight",
                "imageURL", "filterProperties", "imageWidth" }));
    }
