...
public class ImageComponent extends AbstractOutputComponent implements
        IImageCapability, IImageSizeCapability, IAlternateTextCapability,
        IFilterCapability, IImageAccessorsCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "alternateText",
                "imageHeight", "imageURL", "filterProperties", "imageWidth" }));
    }
