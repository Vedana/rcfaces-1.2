...
/**
 * <p>
 * The timeEntry Component is a specialized <a
 * href="/comps/textEntryComponent.html">textEntry Component</a>. it sports
 * auto-completion related to the validity of the numbers entered as a time.
 * </p>
 * <p>
...
public class TimeEntryComponent extends AbstractInputComponent implements
        IRequiredCapability, IAutoTabCapability, IValueChangeEventCapability,
        IFocusStyleClassCapability, ISelectionEventCapability,
        IReadOnlyCapability, ILiteralLocaleCapability,
        ILiteralTimeZoneCapability, IComponentLocaleCapability,
        IComponentTimeZoneCapability, ISeverityStyleClassCapability,
        IAlternateTextCapability, IValidationParameters {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "minTime", "time", "warnStyleClass",
                "defaultTime", "hourStep", "styleClass", "alternateText",
                "infoStyleClass", "componentTimeZone", "secondStep",
                "millisStep", "minuteStep", "errorStyleClass",
                "fatalStyleClass", "autoCompletion", "componentLocale",
                "required", "timeFormat", "valueChangeListener",
                "literalTimeZone", "literalLocale", "readOnly",
                "focusStyleClass", "autoTab", "maxTime" }));
    }
    ...
    public String setValidationParameter(String name, String value,
            boolean client) {
    ...
    public void setValidationParameter(String name, ValueBinding value,
            boolean client) {
    ...
    public Time getTime() {
        ...
        if (value instanceof String) {
            return (Time) LiteralTimeConverter.SINGLETON.getAsObject(null,
                    this, (String) value);
        }

        if (value instanceof IAdaptable) {
            Time adapted = (Time) ((IAdaptable) value).getAdapter(Time.class,
                    this);
            if (adapted != null) {
                return adapted;
            }
    ...
    public void setTime(String time) {
        ...
        Time timeValue = (Time) LiteralTimeConverter.SINGLETON.getAsObject(
                null, this, time);
        setTime(timeValue);
    ...
    public void setComponentLocale(String locale) {
        ...
        setComponentLocale((Locale) LocaleConverter.SINGLETON.getAsObject(null,
                this, locale));
    ...
    public void setComponentTimeZone(String timeZone) {
        ...
        setComponentTimeZone((TimeZone) TimeZoneConverter.SINGLETON
                .getAsObject(null, this, timeZone));
    ...
    private Object setValidationParameterData(String name, Object value,
            boolean client) {
    ...
    public java.util.Locale getComponentLocale(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.Locale) engine.getProperty(
                Properties.COMPONENT_LOCALE, facesContext);
    }
    ...
    /**
     * See {@link #getComponentTimeZone() getComponentTimeZone()} for more
     * details
     */
    public java.util.TimeZone getComponentTimeZone(
            javax.faces.context.FacesContext facesContext) {
        return (java.util.TimeZone) engine.getProperty(
                Properties.COMPONENT_TIME_ZONE, facesContext);
    }
    ...
    /**
     * Returns a boolean value indicating if the component should complete
     * automaticaly the user entry.
     * 
    ...
    /**
     * Sets a boolean value indicating if the component should complete
     * automaticaly the user entry.
     * 
    ...
    /**
     * Returns a time value indicating the minimum acceptable time for the
     * component. The first accepted value is greater than minTime.
     * 
     * @return min Time
     */
    ...
    /**
     * Sets a time value indicating the minimum acceptable time for the
     * component. The first accepted value is greater than minTime.
     * 
     * @param minTime
     *            min Time
    ...
    /**
     * Returns a time value indicating the maximum acceptable time for the
     * component. The last accepted value is lesser than maxTime.
     * 
     * @return max time
     */
    ...
    /**
     * Sets a time value indicating the maximum acceptable time for the
     * component. The last accepted value is lesser than maxTime.
     * 
     * @param maxTime
     *            max time
    ...
    /**
     * Returns an int value specifying the step used for the hour field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @return step used
     */
    ...
    /**
     * Sets an int value specifying the step used for the hour field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @param hourStep
     *            stop to use
    ...
    /**
     * Returns an int value specifying the step used for the minute field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @return step
     */
    ...
    /**
     * Steps an int value specifying the step used for the minute field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @param minuteStep
     *            step
    ...
    /**
     * Returns an int value specifying the step used for the second field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @return step
     */
    ...
    /**
     * Sets an int value specifying the step used for the second field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @param secondStep
     *            step
    ...
    /**
     * Returns an int value specifying the step used for the millisecond field
     * when increasing/decreasing the value with the up/down arrows.
     * 
     * @return step
     */
    ...
    /**
     * Sets an int value specifying the step used for the millisecond field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @param millisStep
     *            step
