...
public class TimeEntryComponent extends AbstractInputComponent implements
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                ...
                "defaultTime", "hourStep", "styleClass", "infoStyleClass",
                "componentTimeZone", "secondStep", "millisStep", "minuteStep",
                "errorStyleClass", "fatalStyleClass", "autoCompletion",
                "componentLocale", "required", "timeFormat",
                "valueChangeListener", "literalTimeZone", "literalLocale",
                "readOnly", "focusStyleClass", "autoTab", "maxTime" }));
    }
