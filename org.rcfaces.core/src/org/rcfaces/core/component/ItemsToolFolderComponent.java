...
public class ItemsToolFolderComponent extends AbstractInputComponent implements
        IInitEventCapability, IMenuCapability, IMouseEventCapability,
        IDoubleClickEventCapability, IBorderTypeCapability,
        ITextPositionCapability, ISelectionEventCapability,
        ICheckEventCapability, ICheckedValuesCapability, IDisabledCapability,
        IReadOnlyCapability, IVerticalAlignmentCapability,
        IShowDropDownMarkCapability, NamingContainer {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "verticalAlignment", "disabled",
                "doubleClickListener", "mouseOverListener", "itemHiddenMode",
                "showDropDownMark", "checkListener", "checkedValues",
                "initListener", "mouseOutListener", "borderType", "readOnly",
                "textPosition" }));
    }
    ...
    public final void setItemHiddenMode(String hiddenMode) {
        ...
        setItemHiddenMode(((Integer) HiddenModeConverter.SINGLETON.getAsObject(
    ...
    public final int getItemHiddenMode(
            javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.ITEM_HIDDEN_MODE, 0,
                facesContext);
    }
