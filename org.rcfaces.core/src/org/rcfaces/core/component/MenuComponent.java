...
/**
 * <p>
 * The menu Component provides a way of creating desktop style menus on web
 * pages. It allows sub-menus, check and radio menu items and image menus. It
 * also provides pop-up menus.
 * </p>
 * <p>
...
public class MenuComponent extends CameliaSelectManyComponent implements
        IPreloadedLevelDepthCapability, IMenuEventCapability,
        ISelectionEventCapability, ICheckEventCapability,
        ICheckedValuesCapability, ICheckComponent,
        IComponentValueTypeCapability, IMenuComponent {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "menuId", "converter", "checkedValues",
                "checkListener", "preloadedLevelDepth", "removeAllWhenShown",
                "menuListener" }));
    }
    ...
    /**
     * Returns an id used to retreive a specific menu. For example, "#node" is
     * used to call a menu on a tree node while "#body" is used for the menu
     * boody.
     * 
     * @return menu Id
     */
    ...
    /**
     * Sets an id used to retreive a specific menu. For example, "#node" is used
     * to call a menu on a tree node while "#body" is used for the menu boody.
     * 
     * @param menuId
     *            menu Id
     */
