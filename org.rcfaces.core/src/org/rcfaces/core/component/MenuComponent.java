...
public class MenuComponent extends CameliaSelectManyComponent implements
        IMenuEventCapability, ISelectionEventCapability, ICheckEventCapability,
        IMenuComponent {
    ...
    public final Object[] getSelectionValues(
        ...
        return (Object[]) engine.getValue(Properties.SELECTION_VALUES,
                facesContext);
    }
    ...
    public final Object[] getCheckValues(
        ...
        return (Object[]) engine
                .getValue(Properties.CHECK_VALUES, facesContext);
    }
