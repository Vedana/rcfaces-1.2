...
public class ComponentsColumnComponent extends CameliaColumnComponent implements
        ...
        IMenuPopupIdCapability, IWidthRangeCapability,
        IVerticalAlignmentCapability, ICellStyleClassCapability,
        ICellToolTipTextCapability, ICellToolTipTextSettings,
        IImageAccessorsCapability, ICellStyleClassSettings {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "imageURL",
                "width", "verticalAlignment", "defaultCellStyleClass",
                "alignment", "hiddenMode", "foregroundColor", "menuPopupId",
                "styleClass", "sortListener", "sortComparator",
                "selectedImageURL", "hoverImageURL", "imageHeight", "maxWidth",
                "disabledImageURL", "ascending", "toolTipText",
                "cellToolTipText", "minWidth", "textDirection", "resizable",
                "text", "imageWidth", "cellStyleClass",
                "cellDefaultToolTipText", "visible", "backgroundColor" }));
    }
