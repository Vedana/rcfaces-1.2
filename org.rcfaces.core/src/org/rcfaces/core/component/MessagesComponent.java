...
/**
 * <p>
 * The messages Component is a placeholder for error messages (several messages
...
public class MessagesComponent extends AbstractMessagesComponent implements
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            AbstractMessagesComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "showActiveComponentMessage", "errorStyleClass",
                "showIfMessage", "styleClass", "fatalStyleClass",
                "infoStyleClass", "warnStyleClass" }));
    }
