 ...
 */
public abstract class AbstractMessagesComponent extends
        CameliaMessagesComponent implements IVisibilityCapability,
        ISizeCapability, IMouseEventCapability, IHelpCapability,
        IClientDataCapability, ILookAndFeelCapability, IPositionCapability,
        IErrorEventCapability, IMarginCapability,
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaMessagesComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "width",
                "marginRight", "hiddenMode", "helpMessage", "foregroundColor",
                "styleClass", "height", "globalOnly", "margins",
                "initListener", "propertyChangeListener", "mouseOutListener",
                "waiRole", "toolTipText", "mouseOverListener",
                "userEventListener", "showDetail", "marginBottom", "helpURL",
                "showSummary", "y", "visible", "lookId", "marginLeft",
                "marginTop", "errorListener", "backgroundColor", "x" }));
    }
