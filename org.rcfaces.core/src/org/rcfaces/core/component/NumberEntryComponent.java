...
public class NumberEntryComponent extends AbstractInputComponent implements
        ...
        IReadOnlyCapability, INumberFormatTypeCapability,
        ILiteralLocaleCapability, IComponentLocaleCapability,
        ISeverityStyleClassCapability, IAlternateTextCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "numberFormat", "numberFormatType",
                "warnStyleClass", "styleClass", "alternateText",
                "infoStyleClass", "fractionDigits", "number",
                "errorStyleClass", "fatalStyleClass", "autoCompletion",
                "componentLocale", "required", "minimum", "defaultNumber",
                "valueChangeListener", "integerStep", "integerDigits",
                "fractionStep", "maximum", "literalLocale", "readOnly",
                "focusStyleClass", "autoTab" }));
    }
    ...
    public void setValue(Object value) {
        ...
        if (value instanceof String) {
            value = LiteralNumberConverter.SINGLETON.getAsObject(null, this,
                    (String) value);
        }
    ...
    public void setNumberFormatType(String formatType) {
        ...
        setNumberFormatType(((Integer) NumberFormatTypeConverter.SINGLETON
                .getAsObject(null, this, formatType)).intValue());
    ...
    public void setMinimum(String number) {
        ...
        Number numberObject = (Number) LiteralNumberConverter.SINGLETON
                .getAsObject(null, this, number);
    ...
    public int getNumberFormatType(javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.NUMBER_FORMAT_TYPE, 0,
                facesContext);
    }
    ...
    /**
     * Returns an int value indicating the number of digits to show before the
     * decimal separator.
     * 
    ...
    public int getIntegerDigits(javax.faces.context.FacesContext facesContext) {
        return engine
                .getIntProperty(Properties.INTEGER_DIGITS, 0, facesContext);
    }

    /**
     * Sets an int value indicating the number of digits to show before the
     * decimal separator.
     * 
     * @param integerDigits
    ...
    /**
     * Returns an int value indicating the number of digits to show after the
     * decimal separator.
     * 
    ...
    public int getFractionDigits(javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.FRACTION_DIGITS, 0,
                facesContext);
    }

    /**
     * Sets an int value indicating the number of digits to show after the
     * decimal separator.
     * 
    ...
    /**
     * Returns a string value specifying the format to use (compliant with java
     * format).
     * 
    ...
    /**
     * Sets a string value specifying the format to use (compliant with java
     * format).
     * 
     * @param numberFormat
     *            number format
    ...
    /**
     * Returns an int value specifying the step used for the integer field when
    ...
    /**
     * Sets an int value specifying the step used for the integer field when
     * increasing/decreasing the value with the up/down arrows.
     * 
     * @param integerStep
     *            step
    ...
    public Number getDefaultNumber(javax.faces.context.FacesContext facesContext) {
        return (Number) engine
                .getValue(Properties.DEFAULT_NUMBER, facesContext);
    }
    ...
    /**
     * Returns an int value specifying the upper limit for the value of the
     * component.
     * 
     * @return maximum
     */
    ...
    /**
     * Sets an int value specifying the upper limit for the value of the
     * component.
     * 
     * @param maximum
     *            maximum
