...
public class NumberEntryComponent extends AbstractInputComponent implements
        ...
        ISeverityStyleClassCapability, IValidationParameters {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "errorStyleClass", "numberFormat",
                "autoCompletion", "fatalStyleClass", "minimum", "required",
                "componentLocale", "defaultNumber", "numberFormatType",
                "valueChangeListener", "integerStep", "fractionStep",
                "integerDigits", "warnStyleClass", "maximum", "styleClass",
                "literalLocale", "infoStyleClass", "fractionDigits",
                "readOnly", "focusStyleClass", "autoTab", "number" }));
    }
