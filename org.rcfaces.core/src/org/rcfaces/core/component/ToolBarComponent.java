...
public class ToolBarComponent extends AbstractBasicComponent implements
        ...
        IBorderTypeCapability, IImageAccessorsCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "separatorImageWidth", "verticalAlignment",
                "separatorAlternateText", "separatorImageHeight",
                "controlAlternateText", "controlImageURL", "separatorImageURL",
                "locked", "itemPadding", "initListener", "controlImageWidth",
                "borderType", "controlImageHeight" }));
    }
    ...
    public String getSeparatorAlternateText(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.SEPARATOR_ALTERNATE_TEXT,
                facesContext);
    }

    public void setSeparatorAlternateText(String separatorAlternateText) {
        engine.setProperty(Properties.SEPARATOR_ALTERNATE_TEXT,
                separatorAlternateText);
    }

    /**
     * Returns <code>true</code> if the attribute "separatorAlternateText" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public String getControlAlternateText(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.CONTROL_ALTERNATE_TEXT,
                facesContext);
    }

    public void setControlAlternateText(String controlAlternateText) {
        engine.setProperty(Properties.CONTROL_ALTERNATE_TEXT,
                controlAlternateText);
    }

    /**
     * Returns <code>true</code> if the attribute "controlAlternateText" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
