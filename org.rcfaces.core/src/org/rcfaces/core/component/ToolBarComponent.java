...
public class ToolBarComponent extends AbstractBasicComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"controlImageURL","separatorImageWidth","separatorImageURL","locked","itemPadding","verticalAlignment","initListener","controlImageWidth","separatorImageHeight","controlImageHeight"}));
	}
