...
public class DataGridComponent extends AbstractGridComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"selectionListener","rowValueColumnId","horizontalScrollPosition","doubleClickListener","rowIndexVar","selectable","showValue","filterProperties","additionalValues","checkable","checkedValues","preference","additionalInformationListener","border","checkCardinality","verticalScrollPosition","paged","required","disabled","cursorValue","clientCheckFullState","rowStyleClass","headerVisible","rowCountVar","clientSelectionFullState","checkListener","selectionCardinality","readOnly","selectedValues"}));
	}
