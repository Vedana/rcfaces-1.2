...
public class ToolFolderComponent extends AbstractBasicComponent implements
        ...
        IDoubleClickEventCapability, IVerticalAlignmentCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "verticalAlignment", "initListener", "doubleClickListener",
                "mouseOverListener", "borderType", "mouseOutListener" }));
    }
