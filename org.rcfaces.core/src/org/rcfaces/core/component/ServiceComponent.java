 ...
 * </p>
 * <p>
 * It allows to (synchronously or asynchronously) call AJAX services from the
 * client.
 * </p>
 * <p>
...
public class ServiceComponent extends CameliaBaseComponent implements
        ...
        IFilterCapability, IComponentLocaleCapability,
        IComponentTimeZoneCapability, IServerDataManager, IClientDataManager {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "serviceId",
                "filterProperties", "componentLocale", "enableViewState",
                "propertyChangeListener", "componentTimeZone",
    ...
    public boolean isEnableViewState(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.ENABLE_VIEW_STATE, true,
                facesContext);
    }
