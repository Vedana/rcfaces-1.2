 ...
 */
public abstract class AbstractMenuComponent extends
        AbstractConverterCommandComponent implements ISelectionEventCapability,
        ICheckEventCapability, ICheckedValuesCapability, IReadOnlyCapability,
        ICheckComponent, IComponentValueTypeCapability, IMenuComponent {

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            AbstractConverterCommandComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "checkedValues", "checkListener",
                "removeAllWhenShown", "readOnly" }));
    }
