...
/**
 * <p>
 * The spinner Component is a <a href="/comps/textEntryComponent.html">textEntry
 * Component</a> that accepts numbers and whose value can be incremented or
 * decremented (by a parametrable step) with buttons or the keyboard arrows.
 * </p>
 * <p>
...
public class SpinnerComponent extends TextEntryComponent {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "minimum",
                "step", "cycleValue", "maximum" }));
    }
    ...
    /**
     * Returns a boolean value indicating wether to start from the beginning
     * when reaching the end or not. And vice versa.
     * 
    ...
    public boolean isCycleValue(javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.CYCLE_VALUE, false,
                facesContext);
    }

    /**
     * Sets a boolean value indicating wether to start from the beginning when
     * reaching the end or not. And vice versa.
     * 
     * @param cycleValue
