...
public class AdditionalInformationComponent extends CameliaBaseComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"scopeValue","waiRole","marginRight","mouseOverListener","backgroundImageVerticalPosition","userEventListener","foregroundColor","marginBottom","loadListener","styleClass","scopeVar","backgroundImageVerticalRepeat","backgroundImageHorizontalPosition","backgroundImageHorizontalRepeat","margins","initListener","backgroundImageURL","propertyChangeListener","mouseOutListener","lookId","marginLeft","marginTop","errorListener","backgroundColor"}));
	}
