...
public class AdditionalInformationComponent extends CameliaColumnComponent
        implements IPropertyChangeEventCapability, IUserEventCapability,
        IErrorEventCapability, IWAIRoleCapability, IMarginCapability,
        IForegroundBackgroundColorCapability, IBackgroundImageCapability,
        ILookAndFeelCapability, IStyleClassCapability, IHeightCapability,
        IMouseEventCapability, IInitEventCapability, ILoadEventCapability,
        IMenuCapability, IVariableScopeCapability, IAsyncRenderComponent {
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaColumnComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "scopeValue",
                "marginRight", "foregroundColor", "loadListener", "styleClass",
                "height", "backgroundImageVerticalRepeat", "initListener",
                "margins", "backgroundImageURL", "propertyChangeListener",
                "mouseOutListener", "waiRole", "mouseOverListener",
                "userEventListener", "backgroundImageVerticalPosition",
                "marginBottom", "scopeVar",
                "backgroundImageHorizontalPosition",
                "backgroundImageHorizontalRepeat", "marginLeft", "lookId",
                "marginTop", "backgroundColor", "errorListener" }));
    }
