...
public class AdditionalInformationComponent extends CameliaColumnComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"scopeValue","marginRight","foregroundColor","loadListener","styleClass","height","backgroundImageVerticalRepeat","initListener","margins","backgroundImageURL","propertyChangeListener","mouseOutListener","waiRole","mouseOverListener","userEventListener","backgroundImageVerticalPosition","marginBottom","scopeVar","backgroundImageHorizontalPosition","backgroundImageHorizontalRepeat","marginLeft","lookId","marginTop","backgroundColor","errorListener"}));
	}
