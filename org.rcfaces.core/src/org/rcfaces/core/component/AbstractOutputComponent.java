 ...
 */
public abstract class AbstractOutputComponent extends CameliaOutputComponent
        implements IVisibilityCapability, ISizeCapability, IHelpCapability,
        IMouseEventCapability, IClientDataCapability,
        IUnlockedClientAttributesCapability, IValueLockedCapability,
        ILookAndFeelCapability, IPositionCapability, IErrorEventCapability,
        IMarginCapability, IForegroundBackgroundColorCapability,
        IStyleClassCapability, IUserEventCapability, IServerDataCapability,
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaOutputComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "width",
                ...
                "mouseOutListener", "waiRole", "mouseOverListener",
                "toolTipText", "userEventListener", "helpURL", "marginBottom",
                "y", "visible", "lookId", "marginLeft", "marginTop",
                "valueLocked", "errorListener", "backgroundColor", "x" }));
    }
