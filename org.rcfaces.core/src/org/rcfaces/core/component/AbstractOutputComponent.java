...
public abstract class AbstractOutputComponent extends CameliaOutputComponent implements 
	...
	static {
		CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {"width","unlockedClientAttributeNames","marginRight","mouseOverListener","toolTipText","hiddenMode","userEventListener","foregroundColor","helpMessage","marginBottom","helpURL","styleClass","height","margins","initListener","visible","y","propertyChangeListener","marginLeft","mouseOutListener","lookId","marginTop","backgroundColor","x"}));
	}
