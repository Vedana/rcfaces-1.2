...
/**
 * <p>
 * The checkButton3States Component is a <a
 * href="/comps/checkButtonComponent.html">CheckButton</a> with 3 states :
 * Check, unchecked and undefined. It is often used to show the state of a group
 * of checkButtons
 * </p>
 * <p>
 * This component is <b>experimental</b>.
 * </p>
 * <p>
 ...
 * </p>
 */
public class CheckButton3StatesComponent extends AbstractInputComponent
        implements ITextCapability, ITextDirectionCapability,
        IHorizontalTextPositionCapability, ISelectionEventCapability,
        IReadOnlyCapability, IAlternateTextCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "alternateText", "text", "selectedState",
                "readOnly", "textPosition", "textDirection" }));
    }
