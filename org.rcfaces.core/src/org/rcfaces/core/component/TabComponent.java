...
/**
 * An element belonging to a <a
 * href="/comps/tabbedPaneComponent.html">tabbedPane Component</a> and holding
 * the components.
 */
public class TabComponent extends CardComponent implements ITextCapability,
        ITextDirectionCapability, IFontCapability, IDisabledCapability,
        IStatesImageCapability, IAccessKeyCapability, IMenuCapability,
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CardComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "fontUnderline",
                "hoverImageURL", "imageURL", "disabledImageURL", "disabled",
                "fontSize", "accessKey", "fontItalic", "textDirection",
                "fontBold", "text", "selectedImageURL", "fontName" }));
    }
