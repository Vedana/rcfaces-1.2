...
public class ComponentsGridComponent extends AbstractDataComponent implements
        ...
        IPreferenceCapability, IPagedCapability, IOrderedChildrenCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "rowValueConverter", "selectionListener",
                "verticalScrollPosition", "paged", "required",
                "horizontalScrollPosition", "doubleClickListener",
                "rowStyleClass", "rowIndexVar", "selectable", "rowCountVar",
    ...
    public final void setRowValueConverter(
