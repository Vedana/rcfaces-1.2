...
public class ComponentsGridComponent extends AbstractDataComponent implements
        ...
        IRowStyleClassCapability, IMenuCapability, IScrollableCapability,
        IPreferenceCapability, IPagedCapability, IHeaderVisibilityCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES
                .addAll(Arrays.asList(new String[] { "rowValueConverter",
                        "selectionListener", "verticalScrollPosition", "paged",
                        "required", "horizontalScrollPosition",
                        "doubleClickListener", "rowStyleClass", "rowIndexVar",
                        "headerVisible", "selectable", "rowCountVar",
                        "clientSelectionFullState", "preference", "border",
    ...
    public final void setSortedColumns(
            ComponentsColumnComponent[] componentsColumns) {
