...
/**
 * <p>
 * The combo Component is equivalent to the standard HTML tag &lt;SELECT
 * SIZE=1&gt;.
 * </p>
 * <p>
...
public class ComboComponent extends AbstractInputComponent implements
        ISelectionEventCapability, IRequiredCapability, IFilterCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "selectionListener", "filterProperties", "required" }));
    }
