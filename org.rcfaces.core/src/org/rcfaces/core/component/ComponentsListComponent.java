...
public class ComponentsListComponent extends AbstractDataComponent implements
        ...
        IScrollableCapability, IShowValueCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES
                .addAll(Arrays.asList(new String[] { "rowCountVar",
                        "verticalScrollPosition", "showValue",
                        "horizontalScrollPosition", "columnStyleClass",
                        "border", "borderType", "rowStyleClass",
