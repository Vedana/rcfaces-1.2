...
/**
 * <p>
 * The suggestTextEntry is a <a href="/comps/textEntryCOmponent.html">textEntry
 * Component</a> with an autosuggestion feature that shows in the form of a
 * dropdown list.
 * </p>
 * <p>
...
public class SuggestTextEntryComponent extends TextEntryComponent implements
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "caseSensitive",
                "suggestionDelayMs", "filterProperties", "moreResultsMessage",
                "suggestionConverter", "suggestionListener", "suggestionValue",
                "forceProposal", "maxResultNumber", "menuListener",
                "suggestionMinChars" }));
    }
    ...
    /**
     * Returns a boolean value indicating if the component should consider the
     * case of the user input when using the data.
     * 
    ...
    /**
     * Sets a boolean value indicating if the component should consider the case
     * of the user input when using the data.
     * 
     * @param caseSensitive
    ...
    /**
     * Returns a boolean value indicating if the first proposed value must be
     * automatically appended to the current entry.
     * 
    ...
    /**
     * Sets a boolean value indicating if the first proposed value must be
     * automatically appended to the current entry.
     * 
     * @param forceProposal
     *            if proposal has to be forced
     */
    ...
    /**
     * Returns a string value containing the value for the selected select item
     * object.
     * 
    ...
    /**
     * Sets a string value containing the value for the selected select item
     * object.
     * 
    ...
    /**
     * Returns a string specifying a converter id or a binding to a converter
     * object. This converter will be used for the values of the list items.
     * 
     * @return converter id
     */
    ...
    /**
     * Sets a string specifying a converter id or a binding to a converter
     * object. This converter will be used for the values of the list items.
     * 
     * @param suggestionConverter
     *            converter id
     */
    public void setSuggestionConverter(
     ...
     */
    /**
     * Returns <code>true</code> if the attribute "suggestionConverter" is
     * set.
     * 
     * @return <code>true</code> if the attribute is set.
     */
    ...
    public String getMoreResultsMessage(
            javax.faces.context.FacesContext facesContext) {
        return engine.getStringProperty(Properties.MORE_RESULTS_MESSAGE,
                facesContext);
    }
