 ...
 */
public abstract class AbstractItemComponent extends CameliaItemComponent
        implements IDisabledCapability, IServerDataCapability,
        IClientDataCapability, IServerDataManager, IClientDataManager {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "itemDescription", "itemLabel", "disabled", "itemDisabled",
                "itemValue" }));
    }
