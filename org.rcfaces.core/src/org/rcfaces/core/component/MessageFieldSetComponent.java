...
/**
 * <p>
 * The messageFieldSet Component is a <a
 * href="/comps/fieldSetComponent.html">fieldSet Component</a> combined with a
 * <a href="/comps/messageComponent.html">message COmponent</a> in the title
 * part.
 * </p>
 * <p>
...
public class MessageFieldSetComponent extends FieldSetComponent implements
        IForCapability, ISeverityStyleClassCapability,
    ...
    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            FieldSetComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                "errorStyleClass", "fatalStyleClass", "imageURL",
                "errorImageURL", "warnStyleClass",
                "showActiveComponentMessage", "warnImageURL", "styleClass",
                "infoStyleClass", "infoImageURL", "fatalImageURL",
