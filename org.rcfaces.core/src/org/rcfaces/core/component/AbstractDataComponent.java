 ...
 */
public abstract class AbstractDataComponent extends CameliaDataComponent
        ...
        IResetEventCapability, IStyleClassCapability, IUserEventCapability,
        IServerDataCapability, IHiddenModeCapability, IWAIRoleCapability,
        IPropertyChangeEventCapability, IInitEventCapability,
        IServerDataManager, IClientDataManager {

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaDataComponent.CAMELIA_ATTRIBUTES);
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "width",
                "unlockedClientAttributeNames", "marginRight", "hiddenMode",
                "helpMessage", "foregroundColor", "styleClass", "height",
                "margins", "initListener", "propertyChangeListener",
                "mouseOutListener", "blurListener", "resetListener", "var",
                "value", "rows", "focusListener", "waiRole", "first",
