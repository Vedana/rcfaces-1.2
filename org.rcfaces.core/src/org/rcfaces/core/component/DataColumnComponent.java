...
public class DataColumnComponent extends CameliaValueColumnComponent implements
        ...
        IVerticalAlignmentCapability, IAutoFilterCapability,
        ICellImageCapability, ICellStyleClassCapability,
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] {
                ...
                "hiddenMode", "cellImageURL", "foregroundColor", "menuPopupId",
                "styleClass", "sortListener", "sortComparator",
                "selectedImageURL", "value", "hoverImageURL", "imageHeight",
                "maxWidth", "disabledImageURL", "ascending", "toolTipText",
