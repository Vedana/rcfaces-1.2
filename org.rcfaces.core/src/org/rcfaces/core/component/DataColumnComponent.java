...
public class DataColumnComponent extends CameliaColumnComponent implements
        IVisibilityCapability, ITextCapability, IToolTipCapability,
        IAlignmentCapability, IForegroundBackgroundColorCapability,
        ISortEventCapability, IStyleClassCapability, IOrderCapability,
        ISortComparatorCapability, IResizableCapability, ValueHolder {
    ...
    public final String getVerticalAlign(
            javax.faces.context.FacesContext facesContext) {
        return engine
                .getStringProperty(Properties.VERTICAL_ALIGN, facesContext);
    }
