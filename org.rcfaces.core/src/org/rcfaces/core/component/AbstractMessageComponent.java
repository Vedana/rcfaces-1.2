 ...
 */
public abstract class AbstractMessageComponent extends CameliaMessageComponent
        implements IVisibilityCapability, ISizeCapability,
        IMouseEventCapability, IHelpCapability, IClientDataCapability,
        ...
        IServerDataManager, IClientDataManager, IForCapability {

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(
            CameliaMessageComponent.CAMELIA_ATTRIBUTES);
    static {
