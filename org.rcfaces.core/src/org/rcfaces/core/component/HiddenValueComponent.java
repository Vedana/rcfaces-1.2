...
public class HiddenValueComponent extends CameliaInputComponent implements
        ...
        IValueLockedCapability, IServerDataManager, IClientDataManager {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "immediate",
                "propertyChangeListener", "valueLocked" }));
    }
