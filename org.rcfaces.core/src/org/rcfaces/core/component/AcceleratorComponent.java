...
public class AcceleratorComponent extends CameliaCommandComponent implements
        IKeyPressEventCapability, IImmediateCapability,
        IValidationEventCapability, IForCapability {
    ...
    static {
        CAMELIA_ATTRIBUTES.addAll(Arrays.asList(new String[] { "forItemValue",
                "keyBinding", "validationListener", "immediate",
                "keyPressListener", "for" }));
    }
    ...
    /**
     * Returns a string specifying a value to select in the component identified
     * in the <b>for</b> property.
     * 
    ...
    public String getForItemValue(javax.faces.context.FacesContext facesContext) {
        return engine
                .getStringProperty(Properties.FOR_ITEM_VALUE, facesContext);
    }

    /**
     * Sets a string specifying a value to select in the component identified in
     * the <b>for</b> property.
     * 
     * @param forItemValue
     *            value to select
     */
    ...
    /**
     * Returns a string value specifying the key associated to the component.
     * for example "Alt+F1"
     * 
     * @return key
     */
    ...
    /**
     * Sets a string value specifying the key associated to the component. for
     * example "Alt+F1"
     * 
     * @param keyBinding
     *            key
