...
public class TreeComponent extends AbstractInputComponent implements
        ...
        IMenuCapability, ICheckableCapability, ICheckCardinalityCapability,
        ICheckEventCapability, ISelectableCapability,
    ...
    public final void setDefaultSelectedImageURL(
            ValueBinding defaultSelectedImageURL) {
        engine.setProperty(Properties.DEFAULT_SELECTED_IMAGE_URL,
                defaultSelectedImageURL);
    }
    ...
    public final void setDefaultExpandedImageURL(
            ValueBinding defaultExpandedImageURL) {
        engine.setProperty(Properties.DEFAULT_EXPANDED_IMAGE_URL,
                defaultExpandedImageURL);
    }
    ...
    public final void setDefaultDisabledImageURL(
            ValueBinding defaultDisabledImageURL) {
        engine.setProperty(Properties.DEFAULT_DISABLED_IMAGE_URL,
                defaultDisabledImageURL);
    }
    ...
    public final void setDefaultSelectedLeafImageURL(
            ValueBinding defaultSelectedLeafImageURL) {
        engine.setProperty(Properties.DEFAULT_SELECTED_LEAF_IMAGE_URL,
                defaultSelectedLeafImageURL);
    }
    ...
    public final void setDefaultExpandedLeafImageURL(
            ValueBinding defaultExpandedLeafImageURL) {
        engine.setProperty(Properties.DEFAULT_EXPANDED_LEAF_IMAGE_URL,
                defaultExpandedLeafImageURL);
    }
    ...
    public final void setDefaultDisabledLeafImageURL(
            ValueBinding defaultDisabledLeafImageURL) {
        engine.setProperty(Properties.DEFAULT_DISABLED_LEAF_IMAGE_URL,
                defaultDisabledLeafImageURL);
    }
    ...
    public final boolean isUserExpandable(
            javax.faces.context.FacesContext facesContext) {
        return engine.getBoolProperty(Properties.USER_EXPANDABLE, true,
                facesContext);
    }
    ...
    public final int getPreloadedLevelDepth(
            javax.faces.context.FacesContext facesContext) {
        return engine.getIntProperty(Properties.PRELOADED_LEVEL_DEPTH, 0,
                facesContext);
    }
    ...
    public final Object[] getExpansionValues(
            javax.faces.context.FacesContext facesContext) {
        return (Object[]) engine.getValue(Properties.EXPANSION_VALUES,
                facesContext);
    }
