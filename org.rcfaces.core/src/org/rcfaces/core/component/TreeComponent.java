...
public class TreeComponent extends AbstractInputComponent implements
        ...
        ISelectedValuesCapability, IPreloadedLevelDepthCapability,
        IExpandableCapability, IExpandedValuesCapability, ISelectionComponent,
        ICheckComponent, IComponentValueTypeCapability {
    ...
    public Object getCursorValue(FacesContext facesContext) {
        ...
        Object cursorValue = ComponentTools.getCursorValue(getValue(), this,
                facesContext);
    ...
    public Object getSelectedValues(FacesContext facesContext) {
        ...
        boolean mainValue = isSelectable(facesContext)
                && isCheckable(facesContext) == false;
    ...
    public Object getExpandedValues(FacesContext facesContext) {
        ...
        boolean mainValue = this.isExpandable(facesContext)
                && this.isSelectable(facesContext) == false
    ...
    public void setExpandedValues(Object expandedValues) {
        ...
        if (engine.isPropertySetted(Properties.EXPANDED_VALUES) == false) {
            ...
            boolean mainValue = this.isExpandable()
