...
import org.rcfaces.core.webapp.IRepository.ISet;
...
public abstract class RepositoryServlet extends ExpirationHttpServlet {
    ...
    protected static final boolean BUILD_ID_VERSION_SUPPORT = true;

    // private static final String REPOSITORY_DEV_MODE =
    // "org.rcfaces.core.REPOSITORY_DEV_MODE";

    // protected static final String DEBUG_MODE_PROPERTY =
    // "org.rcfaces.core.DEBUG_MODE";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        String repositoryDevModePropertyName = getRepositoryDevModePropertyName();
        ...
        for (; parameterNames.hasMoreElements();) {
            ...
            parameterName = parameterName.substring(setPrefix.length());
