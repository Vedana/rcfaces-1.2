 ...
 */
public class DropEvent extends ActionEvent implements ITypedEvent {
    ...
    public DropEvent(UIComponent component, String value, Object valueObject,
    ...
    public DropEvent(UIComponent component, int type, int mouseX, int mouseY,
            int buttonsMask, int modifiersMask) {
        this(component, type, mouseX, mouseY, buttonsMask, modifiersMask,
                UNKNOWN_KEY);
    }

    public DropEvent(UIComponent component, int type, int mouseX, int mouseY,
            int buttonsMask, int modifiersMask, int keyCode) {
        super(component);
