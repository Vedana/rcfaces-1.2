...
public class LinkedListEntry<E> extends AbstractSequentialList<E> implements
     ...
     */
    public LinkedListEntry(Collection< ? extends E> c) {
        this();
        addAll(c);
    }
    ...
    public boolean remove(Object o) {
        if (o instanceof LinkedListEntry.Entry) {
            E entry = remove((LinkedListEntry.Entry<E>) o);
            return entry != null;
        }
    ...
    public boolean addAll(int index, Collection< ? extends E> c) {
        ...
        for (int i = 0; i < numNew; i++) {
            Entry<E> e = createEntry((E) a[i], successor, predecessor);
            predecessor.next = e;
            predecessor = e;
        }
    ...
    private class ListItr implements ListIterator<E> {
        ...
        public void remove() {
            ...
            try {
                LinkedListEntry.this.remove(lastReturned);
    ...
    private Entry<E> addBefore(E e, Entry<E> entry) {
        Entry<E> newEntry = createEntry(e, entry, entry.previous);
    ...
    @Override
    public Object clone() {
        LinkedListEntry<E> clone = null;
        try {
            clone = (LinkedListEntry<E>) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new InternalError();
        }

        // Put clone into "virgin" state
        clone.header = createEntry(null, null, null);
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        // Initialize header
        header = createEntry(null, null, null);
        header.next = header.previous = header;
    ...
    protected Entry<E> createEntry(E element, Entry<E> next, Entry<E> previous) {

        return new Entry<E>(element, next, previous);
    }
