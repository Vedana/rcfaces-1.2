...
public class ComboColumnTag extends CameliaTag implements Tag {
    ...
    protected void setProperties(UIComponent uiComponent) {
        if (LOG.isDebugEnabled()) {
            ...
            LOG
                    .debug("  defaultCellStyleClass='" + defaultCellStyleClass
                            + "'");
        ...
        if ((uiComponent instanceof ComboColumnComponent) == false) {
            ...
            throw new IllegalStateException(
                    "Component specified by tag is not instanceof of 'ComboColumnComponent'.");
        }
        ...
        if (sortListeners != null) {
            ListenersTools.parseListener(facesContext, component,
                    ListenersTools.SORT_LISTENER_TYPE, sortListeners);
        }
        ...
        if (autoFilter != null) {
            if (isValueReference(autoFilter)) {
                ...
                component.setValueBinding(Properties.AUTO_FILTER, vb);
        ...
        if (cellImageURL != null) {
            if (isValueReference(cellImageURL)) {
                ...
                component.setValueBinding(Properties.CELL_IMAGE_URL, vb);
        ...
        if (defaultCellImageURL != null) {
            if (isValueReference(defaultCellImageURL)) {
                ValueBinding vb = application
                        .createValueBinding(defaultCellImageURL);
                component
                        .setValueBinding(Properties.DEFAULT_CELL_IMAGE_URL, vb);
        ...
        if (cellStyleClass != null) {
            if (isValueReference(cellStyleClass)) {
                ValueBinding vb = application
                        .createValueBinding(cellStyleClass);
        ...
        if (defaultCellStyleClass != null) {
            if (isValueReference(defaultCellStyleClass)) {
                ValueBinding vb = application
                        .createValueBinding(defaultCellStyleClass);
                component.setValueBinding(Properties.DEFAULT_CELL_STYLE_CLASS,
                        vb);
        ...
        if (cellDefaultToolTipText != null) {
            if (isValueReference(cellDefaultToolTipText)) {
                ValueBinding vb = application
                        .createValueBinding(cellDefaultToolTipText);
                component.setValueBinding(
                        Properties.CELL_DEFAULT_TOOL_TIP_TEXT, vb);
        ...
        if (cellToolTipText != null) {
            if (isValueReference(cellToolTipText)) {
                ValueBinding vb = application
                        .createValueBinding(cellToolTipText);
