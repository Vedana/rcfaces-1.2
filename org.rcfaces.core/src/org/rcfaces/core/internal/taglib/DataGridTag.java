...
public class DataGridTag extends AbstractGridTag implements Tag {
	...
	public final void setAdditionalValues(String additionalValues) {
	...
	protected void setProperties(UIComponent uiComponent) {
		...
		if (additionalValues != null) {
				ValueBinding vb = application.createValueBinding(additionalValues);
				component.setValueBinding(Properties.ADDITIONAL_VALUES, vb);
		}
