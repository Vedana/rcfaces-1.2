...
public class ComponentsGridTag extends AbstractDataTag implements Tag {
    ...
    public final void setAdditionalInformationListener(
            String additionalInformationListeners) {
    ...
    public final void setAdditionalInformationValues(
            String additionalInformationValues) {
    ...
    public final void setClientAdditionalInformationFullState(
            String clientAdditionalInformationFullState) {
    ...
    public final void setAdditionalInformationCardinality(
            String additionalInformationCardinality) {
    ...
    protected void setProperties(UIComponent uiComponent) {
        if (LOG.isDebugEnabled()) {
            ...
            LOG.debug("  additionalInformationValues='"
                    + additionalInformationValues + "'");
            LOG.debug("  clientAdditionalInformationFullState='"
                    + clientAdditionalInformationFullState + "'");
            LOG.debug("  additionalInformationCardinality='"
        ...
        if ((uiComponent instanceof ComponentsGridComponent) == false) {
            ...
            throw new IllegalStateException(
                    "Component specified by tag is not instanceof of 'ComponentsGridComponent'.");
        }
        ...
        if (additionalInformationListeners != null) {
            ListenersTools.parseListener(facesContext, component,
                    ListenersTools.ADDITIONAL_INFORMATION_LISTENER_TYPE,
                    additionalInformationListeners);
        }

        if (additionalInformationValues != null) {
            ValueBinding vb = application
                    .createValueBinding(additionalInformationValues);
            component.setValueBinding(Properties.ADDITIONAL_INFORMATION_VALUES,
                    vb);
        }
        ...
        if (clientAdditionalInformationFullState != null) {
            if (isValueReference(clientAdditionalInformationFullState)) {
                ValueBinding vb = application
                        .createValueBinding(clientAdditionalInformationFullState);
                component
                        .setValueBinding(
                                Properties.CLIENT_ADDITIONAL_INFORMATION_FULL_STATE,
                                vb);

            } else {
                component
                        .setClientAdditionalInformationFullState(getBool(clientAdditionalInformationFullState));
            }
        }
        ...
        if (additionalInformationCardinality != null) {
            if (isValueReference(additionalInformationCardinality)) {
                ValueBinding vb = application
                        .createValueBinding(additionalInformationCardinality);
                component.setValueBinding(
                        Properties.ADDITIONAL_INFORMATION_CARDINALITY, vb);

            } else {
                component
                        .setAdditionalInformationCardinality(getInt(additionalInformationCardinality));
            }
        }
        ...
        if (rowValue != null) {
            if (isValueReference(rowValue)) {
                ...
                throw new javax.faces.FacesException(
                        "Attribute 'rowValue' accept only a binding expression !");
            }
        }
        ...
        if (rowValueConverter != null) {
            if (isValueReference(rowValueConverter)) {
                ValueBinding vb = application
                        .createValueBinding(rowValueConverter);
