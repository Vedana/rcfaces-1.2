 ...
 */
public class HourFilter extends AbstractDynamicPatternTask {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory.getLog(HourFilter.class);

    protected String getRegularExpression(IClientValidatorContext context) {

        StringAppender exp = new StringAppender("[0-9", 16);

        String sup = getParameter(context, "hour.sepSign");
