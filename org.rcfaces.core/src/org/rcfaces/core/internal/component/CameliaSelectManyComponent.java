 ...
 */
public abstract class CameliaSelectManyComponent extends
        javax.faces.component.UISelectMany implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager, IConvertValueHolder {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaSelectManyComponent.class);
