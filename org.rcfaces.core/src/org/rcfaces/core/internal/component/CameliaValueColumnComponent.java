 ...
 */
public abstract class CameliaValueColumnComponent extends
        javax.faces.component.UIColumn implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager, IConvertValueHolder {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaValueColumnComponent.class);
