 ...
 */
public abstract class CameliaCommandComponent extends
        javax.faces.component.UICommand implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaCommandComponent.class);

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(Arrays
            .asList(new String[] { "value", "immediate" }));

    protected transient IComponentEngine engine;

    private transient IStateChildrenList stateChildrenList;

    protected CameliaCommandComponent() {
     ...
     * (context == null) { throw new NullPointerException(); }
     * 
     * if (isRendered()==false || isClientRendered()==false) { return; }
     * 
     * super.encodeBegin(context); }
     * 
     * public void encodeChildren(FacesContext context) throws IOException { if
     * (context == null) { throw new NullPointerException(); }
     * 
     * if (isRendered()==false || isClientRendered()==false) { return; }
     * 
     ...
     * 
     * public void encodeEnd(FacesContext context) throws IOException { if
     * (context == null) { throw new NullPointerException(); }
     * 
     * if (isRendered()==false || isClientRendered()==false) { return; }
     * 
    ...
    public void processDecodes(FacesContext context) {
        ...
        if (this instanceof IVariableScopeCapability) {
            varScope = ComponentTools.processVariableScope(context,
