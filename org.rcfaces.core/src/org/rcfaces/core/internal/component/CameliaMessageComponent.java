 ...
 */
public abstract class CameliaMessageComponent extends
        javax.faces.component.UIMessage implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaMessageComponent.class);
    ...
    protected CameliaMessageComponent() {
