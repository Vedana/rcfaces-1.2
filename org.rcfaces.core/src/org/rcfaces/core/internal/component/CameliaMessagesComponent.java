 ...
 */
public abstract class CameliaMessagesComponent extends
        javax.faces.component.UIMessages implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaMessagesComponent.class);
