 ...
 */
public abstract class CameliaDataComponent extends
        org.rcfaces.core.internal.component.UIData2 implements
        IRCFacesComponent, IContainerManager, ITransientAttributesManager {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaDataComponent.class);
    ...
    protected CameliaDataComponent() {
    ...
    public DataModel getDataModelValue() {
        ...
        return getDataModel();
        /*
         * Object value=getValue(); if (value instanceof DataModel) { return
         * (DataModel)value; }
         * 
         * return null;
         */
