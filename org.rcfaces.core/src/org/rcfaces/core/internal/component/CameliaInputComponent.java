 ...
 */
public abstract class CameliaInputComponent extends
        javax.faces.component.UIInput implements IRCFacesComponent,
        IContainerManager, ITransientAttributesManager, IConvertValueHolder,
        ISubmittedExternalValue {
    private static final String REVISION = "$Revision$";

    private static final Log LOG = LogFactory
            .getLog(CameliaInputComponent.class);

    protected static final Set CAMELIA_ATTRIBUTES = new HashSet(Arrays
            .asList(new String[] { "value", "converter" }));
