...
public class Properties {
	...
	static {
		if (Constants.COMPACTED_PROPERTY_NAME) {
			PropertiesRepository.declareProperties(new String[] {ACCESS_KEY,ALTERNATE_TEXT,CAPTION,CLIP,CLIP_PATH,CLIP_RULE,COLOR,CONVERTER,CURVE_FLATNESS,DATA_MODEL,DISABLED,DISPLAY,DISTANCE_TOLERANCE,FILL,FILL_OPACITY,FILL_RULE,FILTER_PROPERTIES,FOCUS_STYLE_CLASS,FONT_BOLD,FONT_FAMILY,FONT_ITALIC,FONT_NAME,FONT_SIZE,FONT_SIZE_ADJUST,FONT_STRETCH,FONT_STYLE,FONT_UNDERLINE,FONT_VARIANT,FONT_WEIGHT,IMAGE_HEIGHT,IMAGE_URL,IMAGE_WIDTH,IMMEDIATE,ITEM_DESCRIPTION,ITEM_DISABLED,ITEM_LABEL,ITEM_VALUE,OPACITY,OVERFLOW,PIXEL_UNIT_TO_MILLIMETER,RENDERED,ROW_TOOL_TIP_ID,SELECTABLE,STOP_COLOR,STOP_OPACITY,STROKE,STROKE_DASH_ARRAY,STROKE_DASH_OFFSET,STROKE_LINE_CAP,STROKE_LINE_JOIN,STROKE_MITER_LIMIT,STROKE_OPACITY,STROKE_WIDTH,SVG_URL,TAB_INDEX,TARGET_ID,TEXT_ALIGN,TEXT_ANCHOR,TEXT_DECORATION,TEXT_RENDERING,VALUE,VAR,VISIBILITY,WORD_SPACING,WRITING_MODE});
		}
	}
}
