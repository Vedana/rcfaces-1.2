...
public class CSS2Parser {
    ...
    public CSS2Parser(Reader stream, Node ownerNode, String href, String title,
            String media) {
        _parser = new CSSOMParser();
        _is = new InputSource(stream);
    }

    public CSS2Parser(InputStream stream, Node ownerNode, String href,
    ...
    /*
     * public CSS2Parser( InputStream stream, StyleSheet parentStyleSheet,
     * CSSRule ownerRule, String href, String title, String media) {
     * _parentStyleSheet = parentStyleSheet; _ownerRule = ownerRule; _href =
     * href; _title = title; _media = media; }
     * 
     * public CSS2Parser( Reader stream, StyleSheet parentStyleSheet, CSSRule
     * ownerRule, String href, String title, String media) { _parser = new
     * CSSOMParser(); _is = new InputSource(stream); }
     */
