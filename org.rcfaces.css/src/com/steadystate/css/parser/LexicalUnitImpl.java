...
public class LexicalUnitImpl implements LexicalUnit, Serializable {
    ...
    /*
     * public static final short SAC_OPERATOR_COMMA = 0; public static final
     * short SAC_OPERATOR_PLUS = 1; public static final short SAC_OPERATOR_MINUS =
     * 2; public static final short SAC_OPERATOR_MULTIPLY = 3; public static
     * final short SAC_OPERATOR_SLASH = 4; public static final short
     * SAC_OPERATOR_MOD = 5; public static final short SAC_OPERATOR_EXP = 6;
     * public static final short SAC_OPERATOR_LT = 7; public static final short
     * SAC_OPERATOR_GT = 8; public static final short SAC_OPERATOR_LE = 9;
     * public static final short SAC_OPERATOR_GE = 10; public static final short
     * SAC_OPERATOR_TILDE = 11; public static final short SAC_INHERIT = 12;
     * public static final short SAC_INTEGER = 13; public static final short
     * SAC_REAL = 14; public static final short SAC_EM = 15; public static final
     * short SAC_EX = 16; public static final short SAC_PIXEL = 17; public
     * static final short SAC_INCH = 18; public static final short
     * SAC_CENTIMETER = 19; public static final short SAC_MILLIMETER = 20;
     * public static final short SAC_POINT = 21; public static final short
     * SAC_PICA = 22; public static final short SAC_PERCENTAGE = 23; public
     * static final short SAC_URI = 24; public static final short
     * SAC_COUNTER_FUNCTION = 25; public static final short
     * SAC_COUNTERS_FUNCTION = 26; public static final short SAC_RGBCOLOR = 27;
     * public static final short SAC_DEGREE = 28; public static final short
     * SAC_GRADIAN = 29; public static final short SAC_RADIAN = 30; public
     * static final short SAC_MILLISECOND = 31; public static final short
     * SAC_SECOND = 32; public static final short SAC_HERTZ = 33; public static
     * final short SAC_KILOHERTZ = 34; public static final short SAC_IDENT = 35;
     * public static final short SAC_STRING_VALUE = 36; public static final
     * short SAC_ATTR = 37; public static final short SAC_RECT_FUNCTION = 38;
     * public static final short SAC_UNICODERANGE = 39; public static final
     * short SAC_SUB_EXPRESSION = 40; public static final short SAC_FUNCTION =
     * 41; public static final short SAC_DIMENSION = 42;
     */

    /**
     * 
     */
    private static final long serialVersionUID = -1413371833173341519L;
    ...
    public String toDebugString() {
        ...
        case SAC_INTEGER:
            ...
            break;
        case SAC_REAL:
            sb.append("SAC_REAL(").append(trimFloat(getFloatValue())).append(
                    ")");
            break;
        case SAC_EM:
            sb.append("SAC_EM(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_EX:
            sb.append("SAC_EX(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_PIXEL:
            sb.append("SAC_PIXEL(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_INCH:
            sb.append("SAC_INCH(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_CENTIMETER:
            sb.append("SAC_CENTIMETER(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_MILLIMETER:
            sb.append("SAC_MILLIMETER(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_POINT:
            sb.append("SAC_POINT(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_PICA:
            sb.append("SAC_PICA(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_PERCENTAGE:
            sb.append("SAC_PERCENTAGE(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_DEGREE:
            sb.append("SAC_DEGREE(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_GRADIAN:
            sb.append("SAC_GRADIAN(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_RADIAN:
            sb.append("SAC_RADIAN(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_MILLISECOND:
            sb.append("SAC_MILLISECOND(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_SECOND:
            sb.append("SAC_SECOND(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_HERTZ:
            sb.append("SAC_HERTZ(").append(trimFloat(getFloatValue())).append(
                    getDimensionUnitText()).append(")");
            break;
        case SAC_KILOHERTZ:
            sb.append("SAC_KILOHERTZ(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_DIMENSION:
            sb.append("SAC_DIMENSION(").append(trimFloat(getFloatValue()))
                    .append(getDimensionUnitText()).append(")");
            break;
        case SAC_URI:
    ...
    public static LexicalUnit createDimension(LexicalUnit prev, float f,
            String dim) {
    ...
    public static LexicalUnit createFunction(LexicalUnit prev, String name,
            LexicalUnit params) {
    ...
    public void setNextLexicalUnit(LexicalUnit next) { // OO:
        _next = next;
    }

    public void setPreviousLexicalUnit(LexicalUnit prev) { // OO:
        _prev = prev;
    }
}
