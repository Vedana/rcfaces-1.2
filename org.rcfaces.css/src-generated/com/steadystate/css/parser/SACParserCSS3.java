 ...
 * @author Ahmed Ashour
 * @author rbri
 * @version $Id: SACParserCSS3.java,v 1.1.2.2 2013/12/24 11:51:39 oeuillot Exp $
 */
...
//
  final public void importRule(final boolean nonImportRuleFoundBefore) throws ParseException {
    ...
    try {
      ...
      jj_consume_token(SEMICOLON);
            if (false && nonImportRuleFoundBefore)
            {
...
//
  final public LexicalUnit function(LexicalUnit prev) throws ParseException {
    ...
    while (true) {
      ...
      case PERCENTAGE:
        t = jj_consume_token(PERCENTAGE);
                                  param = LexicalUnitImpl.createPercentage(param, floatValue(op, t.image));
        break;
      case LENGTH_PX:
        t = jj_consume_token(LENGTH_PX);
                                  param = LexicalUnitImpl.createPixel(param, floatValue(op, t.image));
        break;
      case LENGTH_CM:
        t = jj_consume_token(LENGTH_CM);
                                  param = LexicalUnitImpl.createCentimeter(param, floatValue(op, t.image));
        break;
      case LENGTH_MM:
        t = jj_consume_token(LENGTH_MM);
                                  param = LexicalUnitImpl.createMillimeter(param, floatValue(op, t.image));
        break;
      case LENGTH_IN:
        t = jj_consume_token(LENGTH_IN);
                                  param = LexicalUnitImpl.createInch(param, floatValue(op, t.image));
        break;
      case LENGTH_PT:
        t = jj_consume_token(LENGTH_PT);
                                  param = LexicalUnitImpl.createPoint(param, floatValue(op, t.image));
        break;
      case LENGTH_PC:
        t = jj_consume_token(LENGTH_PC);
                                  param = LexicalUnitImpl.createPica(param, floatValue(op, t.image));
        break;
      case EMS:
        t = jj_consume_token(EMS);
                                  param = LexicalUnitImpl.createEm(param, floatValue(op, t.image));
        break;
      case EXS:
        t = jj_consume_token(EXS);
                                  param = LexicalUnitImpl.createEx(param, floatValue(op, t.image));
        break;
      case ANGLE_DEG:
        t = jj_consume_token(ANGLE_DEG);
                                  param = LexicalUnitImpl.createDegree(param, floatValue(op, t.image));
        break;
      case ANGLE_RAD:
        t = jj_consume_token(ANGLE_RAD);
                                  param = LexicalUnitImpl.createRadian(param, floatValue(op, t.image));
        break;
      case ANGLE_GRAD:
        t = jj_consume_token(ANGLE_GRAD);
                                  param = LexicalUnitImpl.createGradian(param, floatValue(op, t.image));
        break;
      case TIME_MS:
        t = jj_consume_token(TIME_MS);
                                  param = LexicalUnitImpl.createMillisecond(param, floatValue(op, t.image));
        break;
      case TIME_S:
        t = jj_consume_token(TIME_S);
                                  param = LexicalUnitImpl.createSecond(param, floatValue(op, t.image));
        break;
      case FREQ_HZ:
        t = jj_consume_token(FREQ_HZ);
                                  param = LexicalUnitImpl.createHertz(param, floatValue(op, t.image));
        break;
      case FREQ_KHZ:
        t = jj_consume_token(FREQ_KHZ);
                                  param = LexicalUnitImpl.createKiloHertz(param, floatValue(op, t.image));
        break;
      case HASH:
        param = hexcolor(param);
        break;
      case FUNCTION:
...
//
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0