...
public class SACParser implements Parser, SACParserConstants {
        ...
        private static final Log LOG = LogFactory.getLog(SACParser.class);
  ...
  final public void styleRule() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(RBRACE);
                ...
                PARSING_LOG.error("Exception in styleRule() [source="+_source.getTitle()+":"+(e.currentToken.beginLine+1)+"]", e);
//        System.err.println();
      ...
      while (true) {
        ...
        sel = selector();
            ...
            {if (true) return selList;}
                ...
                PARSING_LOG.error("Exception in selectorList() [source="+_source.getTitle()+":"+(e.currentToken.beginLine+1)+"]", e);
    }
    throw new Error("Missing return statement in function");
  }
      ...
      default:
        ...
        ;
            ...
            _docHandler.property(p, e, priority);
                ...
                PARSING_LOG.error("Exception in declaration() [source="+_source.getTitle()+":"+(ex.currentToken.beginLine+1)+"]", ex);
        noError = false;
        error_skipdecl();
    }
  }
...
//
  ...
  void error_skipblock() throws ParseException {
    ...
    PARSING_LOG.error("Error_skipblock [source="+_source.getTitle()+":"+(e.currentToken.beginLine+1)+"]",e);
  ...
  void error_skipdecl() throws ParseException {
    ParseException e = generateParseException();
    PARSING_LOG.error("error_skipdecl [source="+_source.getTitle()+":"+(e.currentToken.beginLine+1)+"]",e);
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x6000002,0x6000002,0x20000000,0x6000002,0x6000002,0xc0141a00,0xc0141a00,0x6000002,0x6000002,0xe0141a00,0x2,0x2,0x2,0x1200000,0x2,0x0,0x2,0x2,0x40141a00,0x100,0x2,0x40141a00,0x2,0x40141a00,0x40141a00,0x2,0x2,0x2,0x2,0x2,0x800,0x800,0x2,0x0,0x400,0x2,0x0,0x2,0x2,0x0,0x400,0x2,0x0,0x2,0x2,0x2100,0x2,0x2,0x24000,0x2,0x24000,0x24002,0xc000,0x2,0x2,0x0,0x400,0x2,0x0,0x100,0x2,0x2,0x140a00,0x140a00,0x140a00,0x140a00,0x141a00,0x1000,0x2,0x2,0x18010000,0x2,0x200000,0x2,0x18010000,0x2,0x2,0x0,0x2,0x0,0x400,0x2,0x0,0x2,0x0,0x2,0x130e100,0x2100,0xc000,0x0,0x1300000,0x2,0x2,0x2,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x2,0x0,0x0,0x0,0x0,0x0,0x2000005,0x2000005,0x0,0x0,0x2000007,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000004,0x0,0x0,0x2000004,0x0,0x2000004,0x2000004,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x3000000,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x8,0x0,0x13fffff0,0x0,0x0,0x16fffe0,0x13fffff0,0x0,0x0,0x0,};
   }
